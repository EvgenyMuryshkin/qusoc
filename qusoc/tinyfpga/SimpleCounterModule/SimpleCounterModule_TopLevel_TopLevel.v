...
//
// System configuration name is SimpleCounterModule_TopLevel_TopLevel, clock frequency is 1Hz, Top-level
// FSM summary
// -- Packages
module SimpleCounterModule_TopLevel_TopLevel
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	input wire Clock,
...
$readmemh("SimpleCounterModule_TopLevel_TopLevel_State_buff.hex", State_buff);
	end
	...
	assign SimpleCounterModule_L29F29T67_Index = State_counter[31:22];
