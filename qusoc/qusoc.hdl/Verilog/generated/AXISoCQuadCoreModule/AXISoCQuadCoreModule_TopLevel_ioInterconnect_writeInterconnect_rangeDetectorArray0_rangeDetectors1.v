...
//
// System configuration name is AXISoCQuadCoreModule_TopLevel_ioInterconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors1, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module AXISoCQuadCoreModule_TopLevel_ioInterconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors1
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire [31: 0] rangeFrom = 32'b10000000000000000000000000011000;
	wire [31: 0] rangeTo = 32'b10000000000000000000000000011000;
