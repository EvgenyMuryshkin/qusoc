...
[00000004]: JAL x1, 0x000000D8 (0x0xD4)      // 0x0D4000EF
...
[0000001C]: ADDI x8, x2, 32 (0x0x20)         // 0x02010413
[00000020]: SW x10, -20(x8)                  // 0xFEA42623
[00000024]: LW x15, -17(x8)                  // 0xFEC42783
[00000028]: BEQ x15, x0, 20 (0x0x3C)         // 0x00078A63
[0000002C]: LW x14, -18(x8)                  // 0xFEC42703
[00000030]: ADDI x15, x0, 1 (0x0x1)          // 0x00100793
[00000034]: BEQ x14, x15, 16 (0x0x44)        // 0x00F70863
[00000038]: J 0x0000004C                     // 0x0140006F
[0000003C]: ADDI x15, x0, 0 (0x0x0)          // 0x00000793
[00000040]: J 0x00000078                     // 0x0380006F
[00000044]: ADDI x15, x0, 1 (0x0x1)          // 0x00100793
[00000048]: J 0x00000078                     // 0x0300006F
[0000004C]: LW x15, -17(x8)                  // 0xFEC42783
[00000050]: ADDI x15, x15, -1 (0x0xFFFFFFFF) // 0xFFF78793
[00000054]: ADDI x10, x15, 0 (0x0x0)         // 0x00078513
[00000058]: JAL x1, 0x0000000C (0x0xFFFFFFB4) // 0xFB5FF0EF
[0000005C]: ADDI x9, x10, 0 (0x0x0)          // 0x00050493
[00000060]: LW x15, -17(x8)                  // 0xFEC42783
[00000064]: ADDI x15, x15, -2 (0x0xFFFFFFFE) // 0xFFE78793
[00000068]: ADDI x10, x15, 0 (0x0x0)         // 0x00078513
[0000006C]: JAL x1, 0x0000000C (0x0xFFFFFFA0) // 0xFA1FF0EF
[00000070]: ADDI x15, x10, 0 (0x0x0)         // 0x00050793
[00000074]: ADD x15, x9, 15                  // 0x00F487B3
[00000078]: ADDI x10, x15, 0 (0x0x0)         // 0x00078513
[0000007C]: LW x1, 1(x2)                     // 0x01C12083
[00000080]: LW x8, 8(x2)                     // 0x01812403
[00000084]: LW x9, 9(x2)                     // 0x01412483
[00000088]: ADDI x2, x2, 32 (0x0x20)         // 0x02010113
[0000008C]: JALR x0, x1, 0 (0x0x0)           // 0x00008067
[00000090]: ADDI x2, x2, -16 (0x0xFFFFFFF0)  // 0xFF010113
[00000094]: SW x1, 12(x2)                    // 0x00112623
[00000098]: SW x8, 8(x2)                     // 0x00812423
[0000009C]: SW x9, 4(x2)                     // 0x00912223
[000000A0]: ADDI x8, x2, 16 (0x0x10)         // 0x01010413
[000000A4]: LUI x15, 2147483648 (0x0x80000000) // 0x800007B7
[000000A8]: LW x15, 15(x15)                  // 0x0007A783
[000000AC]: LUI x9, 2147483648 (0x0x80000000) // 0x800004B7
[000000B0]: ADDI x10, x15, 0 (0x0x0)         // 0x00078513
[000000B4]: JAL x1, 0x0000000C (0x0xFFFFFF58) // 0xF59FF0EF
[000000B8]: ADDI x15, x10, 0 (0x0x0)         // 0x00050793
[000000BC]: SW x15, 0(x9)                    // 0x00F4A023
[000000C0]: ADDI x0, x0, 0 (0x0x0)           // 0x00000013
[000000C4]: LW x1, 1(x2)                     // 0x00C12083
[000000C8]: LW x8, 8(x2)                     // 0x00812403
[000000CC]: LW x9, 9(x2)                     // 0x00412483
[000000D0]: ADDI x2, x2, 16 (0x0x10)         // 0x01010113
[000000D4]: JALR x0, x1, 0 (0x0x0)           // 0x00008067
[000000D8]: ADDI x2, x2, -16 (0x0xFFFFFFF0)  // 0xFF010113
[000000DC]: SW x1, 12(x2)                    // 0x00112623
[000000E0]: SW x8, 8(x2)                     // 0x00812423
[000000E4]: ADDI x8, x2, 16 (0x0x10)         // 0x01010413
[000000E8]: JAL x1, 0x00000090 (0x0xFFFFFFA8) // 0xFA9FF0EF
[000000EC]: ADDI x0, x0, 0 (0x0x0)           // 0x00000013
[000000F0]: LW x1, 1(x2)                     // 0x00C12083
[000000F4]: LW x8, 8(x2)                     // 0x00812403
[000000F8]: ADDI x2, x2, 16 (0x0x10)         // 0x01010113
[000000FC]: JALR x0, x1, 0 (0x0x0)           // 0x00008067
