...
--
-- System configuration name is FIRDSPWrapperModule_TopLevel_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
...
entity FIRDSPWrapperModule_TopLevel_TopLevel is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRDSPWrapperModule_TopLevel_TopLevel is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
