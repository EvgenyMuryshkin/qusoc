...
--
-- System configuration name is FIRRAMDSPModule_TopLevel_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity FIRRAMDSPModule_TopLevel_TopLevel is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRRAMDSPModule_TopLevel_TopLevel is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	FIRRAMDSPModule_TopLevel_TopLevel_u_dsp : entity work.FIRRAMDSPModule_TopLevel_TopLevel_u_dsp
	port map
	(
	...
	;
	FIRRAMDSPModule_TopLevel_TopLevel_u_ram : entity work.FIRRAMDSPModule_TopLevel_TopLevel_u_ram
	port map
	(
	...
	begin
		...
		u_ram_CE <= FIRRAMDSPModule_L47F22T26_Expr;
		u_ram_DIN <= Inputs_iRAM_WR_DATA;
		u_ram_RD <= Inputs_iRAM_RD;
		...
		u_dsp_CE <= Inputs_iDSP_CE;
		u_dsp_D <= Inputs_iDSP_D;
		u_dsp_OPMODE <= Inputs_iDSP_OPMODE;
		u_dsp_PCIN <= Inputs_iDSP_PCIN;
		u_dsp_RST <= FIRRAMDSPModule_L58F23T28_Expr;
		oDSP_P <= u_dsp_P;
