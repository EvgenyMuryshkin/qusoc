...
--
-- System configuration name is FIRRAMDSPModule_TopLevel_TopLevel_u_ram, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity FIRRAMDSPModule_TopLevel_TopLevel_u_ram is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRRAMDSPModule_TopLevel_TopLevel_u_ram is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal Inputs_WR_ADDR : unsigned(7 downto 0) := (others => '0');
	signal Inputs_DIN : unsigned(15 downto 0) := (others => '0');
	signal Inputs_RD : std_logic := '0';
	signal Inputs_RD_ADDR : unsigned(7 downto 0) := (others => '0');
