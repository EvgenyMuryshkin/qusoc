...
--
-- System configuration name is FIRRAMDSPModule_TopLevel_u_ram, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity FIRRAMDSPModule_TopLevel_u_ram is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRRAMDSPModule_TopLevel_u_ram is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
