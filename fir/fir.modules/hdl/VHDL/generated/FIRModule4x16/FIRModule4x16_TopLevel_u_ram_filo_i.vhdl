...
--
-- System configuration name is FIRModule4x16_TopLevel_u_ram_filo_i, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity FIRModule4x16_TopLevel_u_ram_filo_i is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRModule4x16_TopLevel_u_ram_filo_i is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
