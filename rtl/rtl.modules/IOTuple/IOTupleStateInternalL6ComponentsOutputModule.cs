...
{
    public class IOTupleStateInternalL6ComponentsOutputModule : RTLSynchronousModule<IOTupleModuleInputs, IOTupleStateInputOutputModuleState>
    {
        ...
        public IOTupleModuleInputsObjectL22 Output_iTuple_Item4_L2Tuple_Item30 => InternalValue.iTuple.Item4.L2Tuple.Item3[0];
        public bool Output_iTuple_Item4_L2Tuple_Item31_L2Flag => InternalValue.iTuple.Item4.L2Tuple.Item3[1].L2Flag;
        public RTLBitArray[] Output_iTuple_Item4_L2Tuple_Item31_L2Values => InternalValue.iTuple.Item4.L2Tuple.Item3[1].L2Values;
        ...
        public bool[] Output_iTupleArray0_Item3_L2_L2Values
            => InternalValue.iTupleArray[0].Item3.L2.L2Values;

        public IOTupleModuleInputsObjectL22 Output_iTupleArray0_Item3_L2Array0
            => InternalValue.iTupleArray[0].Item3.L2Array[0];
        ...
        public RTLBitArray[] Output_iTupleArray0_Item3_L2Array1_L2Values
            => InternalValue.iTupleArray[0].Item3.L2Array[1].L2Values;
        ...
        public IOTupleModuleInputsObjectL21 Output_iTupleArray0_Item3_L2Tuple_Item2
            => InternalValue.iTupleArray[0].Item3.L2Tuple.Item2;
        public IOTupleModuleInputsObjectL22[] Output_iTupleArray0_Item3_L2Tuple_Item3
            => InternalValue.iTupleArray[0].Item3.L2Tuple.Item3;
        ...
        public bool[] Output_iTupleArray0_Item40_L2Values
            => InternalValue.iTupleArray[0].Item4[0].L2Values;

        public IOTupleModuleInputsObjectL21 Output_iTupleArray0_Item41
            => InternalValue.iTupleArray[0].Item4[1];
        ...
        public bool[] Output_iTupleArray1_Item41_L2Values
            => InternalValue.iTupleArray[1].Item4[1].L2Values;
