...
{
    public class IOTupleDirectInputL6ComponentsOutputModule : RTLCombinationalModule<IOTupleModuleInputs>
    {
        ...
        public IOTupleModuleInputsObjectL22 Output_iTuple_Item4_L2Tuple_Item30 => Inputs.iTuple.Item4.L2Tuple.Item3[0];
        public bool Output_iTuple_Item4_L2Tuple_Item31_L2Flag => Inputs.iTuple.Item4.L2Tuple.Item3[1].L2Flag;
        public RTLBitArray[] Output_iTuple_Item4_L2Tuple_Item31_L2Values => Inputs.iTuple.Item4.L2Tuple.Item3[1].L2Values;
        ...
        public bool[] Output_iTupleArray0_Item3_L2_L2Values
            => Inputs.iTupleArray[0].Item3.L2.L2Values;

        public IOTupleModuleInputsObjectL22 Output_iTupleArray0_Item3_L2Array0
            => Inputs.iTupleArray[0].Item3.L2Array[0];
        ...
        public RTLBitArray[] Output_iTupleArray0_Item3_L2Array1_L2Values
            => Inputs.iTupleArray[0].Item3.L2Array[1].L2Values;
        ...
        public IOTupleModuleInputsObjectL21 Output_iTupleArray0_Item3_L2Tuple_Item2
            => Inputs.iTupleArray[0].Item3.L2Tuple.Item2;
        public IOTupleModuleInputsObjectL22[] Output_iTupleArray0_Item3_L2Tuple_Item3
            => Inputs.iTupleArray[0].Item3.L2Tuple.Item3;
        ...
        public bool[] Output_iTupleArray0_Item40_L2Values
            => Inputs.iTupleArray[0].Item4[0].L2Values;

        public IOTupleModuleInputsObjectL21 Output_iTupleArray0_Item41
            => Inputs.iTupleArray[0].Item4[1];
        ...
        public bool[] Output_iTupleArray1_Item41_L2Values
            => Inputs.iTupleArray[1].Item4[1].L2Values;
    }
}
