...
{
    public class SDP_WF_WSTRB_RAMModule_Inputs
    {
    ...
    public class SDP_WF_WSTRB_RAMModule_State
    {
        public byte[] ReadData = new byte[4];
        public byte[][] Buff = Enumerable.Range(0, 32).Select(idx => new byte[4]).ToArray();
    }

    public class SDP_WF_WSTRB_RAMModule : RTLSynchronousModule<SDP_WF_WSTRB_RAMModule_Inputs, SDP_WF_WSTRB_RAMModule_State>
    {
        public SDP_WF_WSTRB_RAMModule()
        {
        }
