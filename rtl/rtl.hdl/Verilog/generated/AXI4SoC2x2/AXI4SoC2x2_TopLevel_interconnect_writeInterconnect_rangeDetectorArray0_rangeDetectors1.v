...
// FSM summary
// -- Packages
module AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors1
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire [2: 0] rangeFrom = 3'b100;
	wire [2: 0] rangeTo = 3'b100;
	...
	assign RangeDetectorModule_L34F33T58_ExprRhs = { {30{1'b0}}, rangeFrom };
	assign RangeDetectorModule_L34F62T85_ExprLhs = { 1'b0, Inputs_Value };
	assign RangeDetectorModule_L34F62T85_ExprRhs = { {30{1'b0}}, rangeTo };
