...
$readmemh("SP_RF_WSTRB_RAMModule_TopLevel_State_Buff0.hex", State_Buff0);
	end
	reg [7 : 0] State_Buff1 [0 : 31];
	initial
	begin : Init_State_Buff1
$readmemh("SP_RF_WSTRB_RAMModule_TopLevel_State_Buff1.hex", State_Buff1);
	end
	reg [7 : 0] State_Buff2 [0 : 31];
	initial
	begin : Init_State_Buff2
$readmemh("SP_RF_WSTRB_RAMModule_TopLevel_State_Buff2.hex", State_Buff2);
	end
	reg [7 : 0] State_Buff3 [0 : 31];
	initial
	begin : Init_State_Buff3
$readmemh("SP_RF_WSTRB_RAMModule_TopLevel_State_Buff3.hex", State_Buff3);
	end
