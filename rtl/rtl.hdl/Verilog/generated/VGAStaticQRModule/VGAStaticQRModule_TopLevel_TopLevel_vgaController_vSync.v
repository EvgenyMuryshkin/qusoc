...
//
// System configuration name is VGAStaticQRModule_TopLevel_TopLevel_vgaController_vSync, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module VGAStaticQRModule_TopLevel_TopLevel_vgaController_vSync
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	assign VGASyncModule_L56F35T58_ExprRhs = { 1'b0, visible };
	assign VGASyncModule_L57F30T54_ExprLhs = { 1'b0, State_counter };
	assign VGASyncModule_L57F30T54_ExprRhs = { 1'b0, visible };
	assign VGASyncModule_L57F58T76_ExprLhs = { 1'b0, State_counter };
	assign VGASyncModule_L57F58T76_ExprRhs = { 1'b0, fp };
	assign VGASyncModule_L58F30T49_ExprLhs = { 1'b0, State_counter };
	assign VGASyncModule_L58F30T49_ExprRhs = { 1'b0, fp };
	assign VGASyncModule_L58F53T71_ExprLhs = { 1'b0, State_counter };
	assign VGASyncModule_L58F53T71_ExprRhs = { 1'b0, sp };
	assign VGASyncModule_L59F30T49_ExprLhs = { 1'b0, State_counter };
	assign VGASyncModule_L59F30T49_ExprRhs = { 1'b0, sp };
