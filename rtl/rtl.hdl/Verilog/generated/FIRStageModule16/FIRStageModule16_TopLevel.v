...
// FSM summary
// -- Packages
module FIRStageModule16_TopLevel
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	input wire Clock,
...
$readmemh("FIRStageModule16_TopLevel_State_coeffRAM.hex", State_coeffRAM);
	end
	reg [15 : 0] State_dataRAM [0 : 127];
	initial
	begin : Init_State_dataRAM
$readmemh("FIRStageModule16_TopLevel_State_dataRAM.hex", State_dataRAM);
	end
