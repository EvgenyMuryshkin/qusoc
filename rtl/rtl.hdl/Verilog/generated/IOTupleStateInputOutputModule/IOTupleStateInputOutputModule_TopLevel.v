...
// FSM summary
// -- Packages
module IOTupleStateInputOutputModule_TopLevel
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	input wire Clock,
...
$readmemh("IOTupleStateInputOutputModule_TopLevel_State_Value_iTuple_Item4_L2_L2Values.hex", State_Value_iTuple_Item4_L2_L2Values);
	end
...
$readmemh("IOTupleStateInputOutputModule_TopLevel_State_Value_iTuple_Item4_L2Tuple_Item2_L2Values.hex", State_Value_iTuple_Item4_L2Tuple_Item2_L2Values);
	end
...
$readmemh("IOTupleStateInputOutputModule_TopLevel_State_Value_iTupleArray.hex", State_Value_iTupleArray);
	end
