...
// FSM summary
// -- Packages
module IOTupleDirectInputComponentsOutputParentModule_TopLevel
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire [59: 0] child_iTuple;
	wire [59: 0] child_Output_iTuple;
	wire [59: 0] child_iTuple_child_iTuple_HardLink;
	wire [53: 0] child_iTupleArray0_child_iTupleArray_HardLink;
	wire [53: 0] child_iTupleArray1_child_iTupleArray_HardLink;
	wire [59: 0] child_Output_iTuple_child_Output_iTuple_HardLink;
	wire [53: 0] child_Output_iTupleArray0_child_Output_iTupleArray_HardLink;
	wire [53: 0] child_Output_iTupleArray1_child_Output_iTupleArray_HardLink;
	...
	wire [53 : 0] child_iTupleArray [0 : 1];
	wire [53 : 0] child_Output_iTupleArray [0 : 1];
	IOTupleDirectInputComponentsOutputParentModule_TopLevel_child
	IOTupleDirectInputComponentsOutputParentModule_TopLevel_child
	(
	...
	assign child_iTuple[59] = Inputs_iTuple_Item1;
	assign child_iTuple[58:51] = Inputs_iTuple_Item2;
	assign child_iTuple[50:47] = Inputs_iTuple_Item3[1];
	assign child_iTuple[46:43] = Inputs_iTuple_Item3[0];
	assign child_iTuple[42:35] = Inputs_iTuple_Item4_L2Tuple_Item1;
	assign child_iTuple[34] = Inputs_iTuple_Item4_L2Tuple_Item2_L2Values[1];
	assign child_iTuple[33] = Inputs_iTuple_Item4_L2Tuple_Item2_L2Values[0];
	assign child_iTuple[32] = Inputs_iTuple_Item4_L2Tuple_Item2_L2Flag;
	assign child_iTuple[31:25] = Inputs_iTuple_Item4_L2Tuple_Item3[1];
	assign child_iTuple[24:18] = Inputs_iTuple_Item4_L2Tuple_Item3[0];
	assign child_iTuple[17:11] = Inputs_iTuple_Item4_L2Array[1];
	assign child_iTuple[10:4] = Inputs_iTuple_Item4_L2Array[0];
	assign child_iTuple[3] = Inputs_iTuple_Item4_L2_L2Values[1];
	assign child_iTuple[2] = Inputs_iTuple_Item4_L2_L2Values[0];
	assign child_iTuple[1] = Inputs_iTuple_Item4_L2_L2Flag;
	assign child_iTuple[0] = Inputs_iTuple_Item4_L1Flag;
	assign child_iTupleArray[0] = Inputs_iTupleArray[0];
	assign child_iTupleArray[1] = Inputs_iTupleArray[1];
	assign Output_iTuple_Item1 = child_Output_iTuple[59];
	assign Output_iTuple_Item2 = child_Output_iTuple[58:51];
	assign Output_iTuple_Item31 = child_Output_iTuple[50:47];
	assign Output_iTuple_Item30 = child_Output_iTuple[46:43];
	assign Output_iTuple_Item4_L2Tuple_Item1 = child_Output_iTuple[42:35];
	assign Output_iTuple_Item4_L2Tuple_Item2_L2Values1 = child_Output_iTuple[34];
	assign Output_iTuple_Item4_L2Tuple_Item2_L2Values0 = child_Output_iTuple[33];
	assign Output_iTuple_Item4_L2Tuple_Item2_L2Flag = child_Output_iTuple[32];
	assign Output_iTuple_Item4_L2Tuple_Item31_L2Values1 = child_Output_iTuple[31:29];
	assign Output_iTuple_Item4_L2Tuple_Item31_L2Values0 = child_Output_iTuple[28:26];
	assign Output_iTuple_Item4_L2Tuple_Item31_L2Flag = child_Output_iTuple[25];
	assign Output_iTuple_Item4_L2Tuple_Item30_L2Values1 = child_Output_iTuple[24:22];
	assign Output_iTuple_Item4_L2Tuple_Item30_L2Values0 = child_Output_iTuple[21:19];
	assign Output_iTuple_Item4_L2Tuple_Item30_L2Flag = child_Output_iTuple[18];
	assign Output_iTuple_Item4_L2Array1_L2Values1 = child_Output_iTuple[17:15];
	assign Output_iTuple_Item4_L2Array1_L2Values0 = child_Output_iTuple[14:12];
	assign Output_iTuple_Item4_L2Array1_L2Flag = child_Output_iTuple[11];
	assign Output_iTuple_Item4_L2Array0_L2Values1 = child_Output_iTuple[10:8];
	assign Output_iTuple_Item4_L2Array0_L2Values0 = child_Output_iTuple[7:5];
	assign Output_iTuple_Item4_L2Array0_L2Flag = child_Output_iTuple[4];
	assign Output_iTuple_Item4_L2_L2Values1 = child_Output_iTuple[3];
	assign Output_iTuple_Item4_L2_L2Values0 = child_Output_iTuple[2];
	assign Output_iTuple_Item4_L2_L2Flag = child_Output_iTuple[1];
	assign Output_iTuple_Item4_L1Flag = child_Output_iTuple[0];
	assign Output_iTupleArray0_Item1 = child_Output_iTupleArray[0][53];
	assign Output_iTupleArray0_Item2 = child_Output_iTupleArray[0][52:49];
	assign Output_iTupleArray0_Item3_L2Tuple_Item1 = child_Output_iTupleArray[0][48:41];
	assign Output_iTupleArray0_Item3_L2Tuple_Item2_L2Values1 = child_Output_iTupleArray[0][40];
	assign Output_iTupleArray0_Item3_L2Tuple_Item2_L2Values0 = child_Output_iTupleArray[0][39];
	assign Output_iTupleArray0_Item3_L2Tuple_Item2_L2Flag = child_Output_iTupleArray[0][38];
	assign Output_iTupleArray0_Item3_L2Tuple_Item31_L2Values1 = child_Output_iTupleArray[0][37:35];
	assign Output_iTupleArray0_Item3_L2Tuple_Item31_L2Values0 = child_Output_iTupleArray[0][34:32];
	assign Output_iTupleArray0_Item3_L2Tuple_Item31_L2Flag = child_Output_iTupleArray[0][31];
	assign Output_iTupleArray0_Item3_L2Tuple_Item30_L2Values1 = child_Output_iTupleArray[0][30:28];
	assign Output_iTupleArray0_Item3_L2Tuple_Item30_L2Values0 = child_Output_iTupleArray[0][27:25];
	assign Output_iTupleArray0_Item3_L2Tuple_Item30_L2Flag = child_Output_iTupleArray[0][24];
	assign Output_iTupleArray0_Item3_L2Array1_L2Values1 = child_Output_iTupleArray[0][23:21];
	assign Output_iTupleArray0_Item3_L2Array1_L2Values0 = child_Output_iTupleArray[0][20:18];
	assign Output_iTupleArray0_Item3_L2Array1_L2Flag = child_Output_iTupleArray[0][17];
	assign Output_iTupleArray0_Item3_L2Array0_L2Values1 = child_Output_iTupleArray[0][16:14];
	assign Output_iTupleArray0_Item3_L2Array0_L2Values0 = child_Output_iTupleArray[0][13:11];
	assign Output_iTupleArray0_Item3_L2Array0_L2Flag = child_Output_iTupleArray[0][10];
	assign Output_iTupleArray0_Item3_L2_L2Values1 = child_Output_iTupleArray[0][9];
	assign Output_iTupleArray0_Item3_L2_L2Values0 = child_Output_iTupleArray[0][8];
	assign Output_iTupleArray0_Item3_L2_L2Flag = child_Output_iTupleArray[0][7];
	assign Output_iTupleArray0_Item3_L1Flag = child_Output_iTupleArray[0][6];
	assign Output_iTupleArray0_Item41_L2Values1 = child_Output_iTupleArray[0][5];
	assign Output_iTupleArray0_Item41_L2Values0 = child_Output_iTupleArray[0][4];
	assign Output_iTupleArray0_Item41_L2Flag = child_Output_iTupleArray[0][3];
	assign Output_iTupleArray0_Item40_L2Values1 = child_Output_iTupleArray[0][2];
	assign Output_iTupleArray0_Item40_L2Values0 = child_Output_iTupleArray[0][1];
	assign Output_iTupleArray0_Item40_L2Flag = child_Output_iTupleArray[0][0];
	assign Output_iTupleArray1_Item1 = child_Output_iTupleArray[1][53];
	assign Output_iTupleArray1_Item2 = child_Output_iTupleArray[1][52:49];
	assign Output_iTupleArray1_Item3_L2Tuple_Item1 = child_Output_iTupleArray[1][48:41];
	assign Output_iTupleArray1_Item3_L2Tuple_Item2_L2Values1 = child_Output_iTupleArray[1][40];
	assign Output_iTupleArray1_Item3_L2Tuple_Item2_L2Values0 = child_Output_iTupleArray[1][39];
	assign Output_iTupleArray1_Item3_L2Tuple_Item2_L2Flag = child_Output_iTupleArray[1][38];
	assign Output_iTupleArray1_Item3_L2Tuple_Item31_L2Values1 = child_Output_iTupleArray[1][37:35];
	assign Output_iTupleArray1_Item3_L2Tuple_Item31_L2Values0 = child_Output_iTupleArray[1][34:32];
	assign Output_iTupleArray1_Item3_L2Tuple_Item31_L2Flag = child_Output_iTupleArray[1][31];
	assign Output_iTupleArray1_Item3_L2Tuple_Item30_L2Values1 = child_Output_iTupleArray[1][30:28];
	assign Output_iTupleArray1_Item3_L2Tuple_Item30_L2Values0 = child_Output_iTupleArray[1][27:25];
	assign Output_iTupleArray1_Item3_L2Tuple_Item30_L2Flag = child_Output_iTupleArray[1][24];
	assign Output_iTupleArray1_Item3_L2Array1_L2Values1 = child_Output_iTupleArray[1][23:21];
	assign Output_iTupleArray1_Item3_L2Array1_L2Values0 = child_Output_iTupleArray[1][20:18];
	assign Output_iTupleArray1_Item3_L2Array1_L2Flag = child_Output_iTupleArray[1][17];
	assign Output_iTupleArray1_Item3_L2Array0_L2Values1 = child_Output_iTupleArray[1][16:14];
	assign Output_iTupleArray1_Item3_L2Array0_L2Values0 = child_Output_iTupleArray[1][13:11];
	assign Output_iTupleArray1_Item3_L2Array0_L2Flag = child_Output_iTupleArray[1][10];
	assign Output_iTupleArray1_Item3_L2_L2Values1 = child_Output_iTupleArray[1][9];
	assign Output_iTupleArray1_Item3_L2_L2Values0 = child_Output_iTupleArray[1][8];
	assign Output_iTupleArray1_Item3_L2_L2Flag = child_Output_iTupleArray[1][7];
	assign Output_iTupleArray1_Item3_L1Flag = child_Output_iTupleArray[1][6];
	assign Output_iTupleArray1_Item41_L2Values1 = child_Output_iTupleArray[1][5];
	assign Output_iTupleArray1_Item41_L2Values0 = child_Output_iTupleArray[1][4];
	assign Output_iTupleArray1_Item41_L2Flag = child_Output_iTupleArray[1][3];
	assign Output_iTupleArray1_Item40_L2Values1 = child_Output_iTupleArray[1][2];
	assign Output_iTupleArray1_Item40_L2Values0 = child_Output_iTupleArray[1][1];
	assign Output_iTupleArray1_Item40_L2Flag = child_Output_iTupleArray[1][0];
	assign child_iTuple_child_iTuple_HardLink = child_iTuple;
	assign child_iTupleArray0_child_iTupleArray_HardLink = child_iTupleArray[0];
	assign child_iTupleArray1_child_iTupleArray_HardLink = child_iTupleArray[1];
	assign child_Output_iTuple = child_Output_iTuple_child_Output_iTuple_HardLink;
	assign child_Output_iTupleArray[0] = child_Output_iTupleArray0_child_Output_iTupleArray_HardLink;
	assign child_Output_iTupleArray[1] = child_Output_iTupleArray1_child_Output_iTupleArray_HardLink;
