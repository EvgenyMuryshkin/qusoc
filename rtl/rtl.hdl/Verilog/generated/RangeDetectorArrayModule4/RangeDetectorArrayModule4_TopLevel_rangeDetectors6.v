...
// FSM summary
// -- Packages
module RangeDetectorArrayModule4_TopLevel_rangeDetectors6
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire [30: 0] rangeFrom = 31'b1110000000000000000000000010000;
	wire [31: 0] rangeTo = 32'b11111111111111111111111111111110;
	...
	assign RangeDetectorModule_L34F62T85_ExprRhs = { 1'b0, rangeTo };
