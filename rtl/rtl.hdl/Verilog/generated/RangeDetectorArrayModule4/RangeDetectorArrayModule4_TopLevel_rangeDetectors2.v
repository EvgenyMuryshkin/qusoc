...
// FSM summary
// -- Packages
module RangeDetectorArrayModule4_TopLevel_rangeDetectors2
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire [29: 0] rangeFrom = 30'b100000000000000000000000000000;
	wire [30: 0] rangeTo = 31'b1101111111111111111111111111111;
	...
	assign RangeDetectorModule_L34F33T58_ExprRhs = { {3{1'b0}}, rangeFrom };
