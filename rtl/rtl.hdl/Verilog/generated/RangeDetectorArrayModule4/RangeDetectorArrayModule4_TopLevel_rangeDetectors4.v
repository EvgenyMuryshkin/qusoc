...
// FSM summary
// -- Packages
module RangeDetectorArrayModule4_TopLevel_rangeDetectors4
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire [30: 0] rangeFrom = 31'b1110000000000000000000000000001;
	wire [30: 0] rangeTo = 31'b1110000000000000000000000000001;
	...
	assign RangeDetectorModule_L34F33T58_ExprRhs = { {2{1'b0}}, rangeFrom };
	assign RangeDetectorModule_L34F62T85_ExprLhs = { 1'b0, Inputs_Value };
	assign RangeDetectorModule_L34F62T85_ExprRhs = { {2{1'b0}}, rangeTo };
