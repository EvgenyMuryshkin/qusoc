...
begin
	...
	begin
		...
		S2M(72) <= internalRVALID;
		S2M(71 downto 64) <= Inputs_M2S_AR_ARUSER;
		S2M(63) <= AXI4_S_R_L26F29T33_Expr;
		S2M(62) <= '0';
		S2M(61) <= AXI4NonBufferedSlaveModule_L58F25T37_Expr;
		S2M(60 downto 53) <= Inputs_inRDATA(3);
		S2M(52 downto 45) <= Inputs_inRDATA(2);
		S2M(44 downto 37) <= Inputs_inRDATA(1);
		S2M(36 downto 29) <= Inputs_inRDATA(0);
		S2M(28 downto 21) <= Inputs_M2S_AR_ARID;
		S2M(20) <= internalBVALID;
		S2M(19 downto 12) <= Inputs_M2S_W_WUSER;
		S2M(11) <= '0';
		S2M(10) <= AXI4NonBufferedSlaveModule_L71F25T37_Expr;
		S2M(9 downto 2) <= Inputs_M2S_W_WID;
		S2M(1) <= internalAWREADY;
