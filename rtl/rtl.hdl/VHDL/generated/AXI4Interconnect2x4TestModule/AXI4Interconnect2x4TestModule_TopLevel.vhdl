...
begin
	...
	begin
		...
		masters0_S2M(72) <= notActiveS2M_R_RVALID;
		masters0_S2M(71 downto 64) <= notActiveS2M_R_RUSER;
		masters0_S2M(63) <= notActiveS2M_R_RLAST;
		masters0_S2M(62 downto 61) <= notActiveS2M_R_RRESP;
		masters0_S2M(60 downto 53) <= notActiveS2M_R_RDATA(3);
		masters0_S2M(52 downto 45) <= notActiveS2M_R_RDATA(2);
		masters0_S2M(44 downto 37) <= notActiveS2M_R_RDATA(1);
		masters0_S2M(36 downto 29) <= notActiveS2M_R_RDATA(0);
		masters0_S2M(28 downto 21) <= notActiveS2M_R_RID;
		masters0_S2M(20) <= notActiveS2M_B_BVALID;
		masters0_S2M(19 downto 12) <= notActiveS2M_B_BUSER;
		masters0_S2M(11 downto 10) <= notActiveS2M_B_BRESP;
		masters0_S2M(9 downto 2) <= notActiveS2M_B_BID;
		masters0_S2M(1) <= notActiveS2M_AW_AWREADY;
		...
		masters1_S2M(72) <= notActiveS2M_R_RVALID;
		masters1_S2M(71 downto 64) <= notActiveS2M_R_RUSER;
		masters1_S2M(63) <= notActiveS2M_R_RLAST;
		masters1_S2M(62 downto 61) <= notActiveS2M_R_RRESP;
		masters1_S2M(60 downto 53) <= notActiveS2M_R_RDATA(3);
		masters1_S2M(52 downto 45) <= notActiveS2M_R_RDATA(2);
		masters1_S2M(44 downto 37) <= notActiveS2M_R_RDATA(1);
		masters1_S2M(36 downto 29) <= notActiveS2M_R_RDATA(0);
		masters1_S2M(28 downto 21) <= notActiveS2M_R_RID;
		masters1_S2M(20) <= notActiveS2M_B_BVALID;
		masters1_S2M(19 downto 12) <= notActiveS2M_B_BUSER;
		masters1_S2M(11 downto 10) <= notActiveS2M_B_BRESP;
		masters1_S2M(9 downto 2) <= notActiveS2M_B_BID;
		masters1_S2M(1) <= notActiveS2M_AW_AWREADY;
