...
use work.Quokka.all;
entity AXI4SoC2x2_TopLevel_registers0 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4SoC2x2_TopLevel_registers0 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	AXI4SoC2x2_TopLevel_registers0_axiSlave : entity work.AXI4SoC2x2_TopLevel_registers0_axiSlave
	port map
	(
	...
	begin
		...
		AXI4RegisterModule_L66F37L75T14_Object(7 downto 0) <= Inputs_M2S_R_AR_ARID;
		AXI4RegisterModule_L66F37L75T14_Object(39 downto 8) <= Inputs_M2S_R_AR_ARADDR;
		AXI4RegisterModule_L66F37L75T14_Object(47 downto 40) <= Inputs_M2S_R_AR_ARLEN;
		AXI4RegisterModule_L66F37L75T14_Object(50 downto 48) <= Inputs_M2S_R_AR_ARSIZE;
		AXI4RegisterModule_L66F37L75T14_Object(52 downto 51) <= Inputs_M2S_R_AR_ARBURST;
		AXI4RegisterModule_L66F37L75T14_Object(54 downto 53) <= Inputs_M2S_R_AR_ARLOCK;
		AXI4RegisterModule_L66F37L75T14_Object(58 downto 55) <= Inputs_M2S_R_AR_ARCACHE;
		AXI4RegisterModule_L66F37L75T14_Object(61 downto 59) <= Inputs_M2S_R_AR_ARPROT;
		AXI4RegisterModule_L66F37L75T14_Object(65 downto 62) <= Inputs_M2S_R_AR_ARQOS;
		AXI4RegisterModule_L66F37L75T14_Object(73 downto 66) <= Inputs_M2S_R_AR_ARREGION;
		AXI4RegisterModule_L66F37L75T14_Object(81 downto 74) <= Inputs_M2S_R_AR_ARUSER;
		AXI4RegisterModule_L66F37L75T14_Object(82) <= Inputs_M2S_R_AR_ARVALID;
		AXI4RegisterModule_L66F37L75T14_Object(83) <= Inputs_M2S_R_R_RREADY;
		AXI4RegisterModule_L66F37L75T14_Object(91 downto 84) <= Inputs_M2S_W_AW_AWID;
		AXI4RegisterModule_L66F37L75T14_Object(123 downto 92) <= Inputs_M2S_W_AW_AWADDR;
		AXI4RegisterModule_L66F37L75T14_Object(131 downto 124) <= Inputs_M2S_W_AW_AWLEN;
		AXI4RegisterModule_L66F37L75T14_Object(134 downto 132) <= Inputs_M2S_W_AW_AWSIZE;
		AXI4RegisterModule_L66F37L75T14_Object(136 downto 135) <= Inputs_M2S_W_AW_AWBURST;
		AXI4RegisterModule_L66F37L75T14_Object(138 downto 137) <= Inputs_M2S_W_AW_AWLOCK;
		AXI4RegisterModule_L66F37L75T14_Object(142 downto 139) <= Inputs_M2S_W_AW_AWCACHE;
		AXI4RegisterModule_L66F37L75T14_Object(145 downto 143) <= Inputs_M2S_W_AW_AWPROT;
		AXI4RegisterModule_L66F37L75T14_Object(149 downto 146) <= Inputs_M2S_W_AW_AWQOS;
		AXI4RegisterModule_L66F37L75T14_Object(157 downto 150) <= Inputs_M2S_W_AW_AWREGION;
		AXI4RegisterModule_L66F37L75T14_Object(165 downto 158) <= Inputs_M2S_W_AW_AWUSER;
		AXI4RegisterModule_L66F37L75T14_Object(166) <= Inputs_M2S_W_AW_AWVALID;
		AXI4RegisterModule_L66F37L75T14_Object(174 downto 167) <= Inputs_M2S_W_W_WID;
		AXI4RegisterModule_L66F37L75T14_Object(206 downto 199) <= Inputs_M2S_W_W_WDATA(3);
		AXI4RegisterModule_L66F37L75T14_Object(198 downto 191) <= Inputs_M2S_W_W_WDATA(2);
		AXI4RegisterModule_L66F37L75T14_Object(190 downto 183) <= Inputs_M2S_W_W_WDATA(1);
		AXI4RegisterModule_L66F37L75T14_Object(182 downto 175) <= Inputs_M2S_W_W_WDATA(0);
		AXI4RegisterModule_L66F37L75T14_Object(210 downto 207) <= Inputs_M2S_W_W_WSTRB;
		AXI4RegisterModule_L66F37L75T14_Object(211) <= Inputs_M2S_W_W_WLAST;
		AXI4RegisterModule_L66F37L75T14_Object(219 downto 212) <= Inputs_M2S_W_W_WUSER;
		AXI4RegisterModule_L66F37L75T14_Object(220) <= Inputs_M2S_W_W_WVALID;
		AXI4RegisterModule_L66F37L75T14_Object(221) <= Inputs_M2S_W_B_BREADY;
