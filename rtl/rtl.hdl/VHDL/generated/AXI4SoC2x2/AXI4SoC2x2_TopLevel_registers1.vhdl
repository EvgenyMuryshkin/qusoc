...
use work.Quokka.all;
entity AXI4SoC2x2_TopLevel_registers1 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4SoC2x2_TopLevel_registers1 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	AXI4SoC2x2_TopLevel_registers1_axiSlave : entity work.AXI4SoC2x2_TopLevel_registers1_axiSlave
	port map
	(
