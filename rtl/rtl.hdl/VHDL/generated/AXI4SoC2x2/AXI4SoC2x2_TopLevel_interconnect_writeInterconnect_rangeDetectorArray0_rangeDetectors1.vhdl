...
--
-- System configuration name is AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors1, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors1 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors1 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
