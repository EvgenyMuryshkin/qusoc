...
--
-- System configuration name is AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray1_rangeDetectors1, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray1_rangeDetectors1 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4SoC2x2_TopLevel_interconnect_writeInterconnect_rangeDetectorArray1_rangeDetectors1 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	begin
		...
		RangeDetectorModule_L34F33T58_ExprRhs(32 downto 3) <= (others => '0');
		RangeDetectorModule_L34F33T58_ExprRhs(2 downto 0) <= signed(rangeFrom);
		RangeDetectorModule_L34F62T85_ExprLhs(32) <= '0';
		RangeDetectorModule_L34F62T85_ExprLhs(31 downto 0) <= signed(Inputs_Value);
		RangeDetectorModule_L34F62T85_ExprRhs(32 downto 3) <= (others => '0');
		RangeDetectorModule_L34F62T85_ExprRhs(2 downto 0) <= signed(rangeTo);
