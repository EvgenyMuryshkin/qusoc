...
use work.Quokka.all;
entity AXI4SoC2x2_TopLevel_interconnect_readInterconnect_DuplexMux is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4SoC2x2_TopLevel_interconnect_readInterconnect_DuplexMux is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
