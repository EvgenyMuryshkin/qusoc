...
--
-- System configuration name is StructByMemberInternalL1MembersModule_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity StructByMemberInternalL1MembersModule_TopLevel is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of StructByMemberInternalL1MembersModule_TopLevel is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	begin
		...
		oL1_L20_L3Tuple_Item1 <= internalL1_L2(0)(36);
		oL1_L20_L3Tuple_Item2_L3RequiredValue <= signed(internalL1_L2(0)(35 downto 20));
		oL1_L20_L3Tuple_Item2_L3OptionalValue <= internalL1_L2(0)(19);
		oL1_L20_L3_L3RequiredValue <= signed(internalL1_L2(0)(18 downto 3));
		oL1_L20_L3_L3OptionalValue <= internalL1_L2(0)(2);
		oL1_L20_L2OptionalValue <= internalL1_L2(0)(1 downto 0);
		oL1_L21_L3Tuple_Item1 <= internalL1_L2(1)(36);
		oL1_L21_L3Tuple_Item2_L3RequiredValue <= signed(internalL1_L2(1)(35 downto 20));
		oL1_L21_L3Tuple_Item2_L3OptionalValue <= internalL1_L2(1)(19);
		oL1_L21_L3_L3RequiredValue <= signed(internalL1_L2(1)(18 downto 3));
		oL1_L21_L3_L3OptionalValue <= internalL1_L2(1)(2);
		oL1_L21_L2OptionalValue <= internalL1_L2(1)(1 downto 0);
	end process;
