...
--
-- System configuration name is AXILikeInteconnectModule_TopLevel_Encoder, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXILikeInteconnectModule_TopLevel_Encoder is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		...
		iValues7 : in std_logic;
		HasActive : out std_logic;
		MSBIndex : out unsigned (2 downto 0);
		MSBValue : out unsigned (7 downto 0)
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of AXILikeInteconnectModule_TopLevel_Encoder is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal AXI4EncoderModule_L30F13L39T14_AXI4EncoderModule_L38F24T51_Resize : unsigned(2 downto 0) := (others => '0');
	signal AXI4EncoderModule_L45F13L54T14_result : std_logic := '0';
	signal AXI4EncoderModule_L59F40T101_ShiftLeft : unsigned(7 downto 0) := (others => '0');
	signal AXI4EncoderModule_L59F40T121_Resize : unsigned(7 downto 0) := (others => '0');
	signal AXI4EncoderModule_L59F40T101_Expr : unsigned(7 downto 0) := "00000000";
	signal AXI4EncoderModule_L59F40T101_Expr_1 : unsigned(7 downto 0) := "00000000";
	type Inputs_iValuesArray is array (0 to 7) of std_logic;
