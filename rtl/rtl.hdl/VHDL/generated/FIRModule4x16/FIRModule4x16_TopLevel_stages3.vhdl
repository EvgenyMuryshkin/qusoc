...
use work.Quokka.all;
entity FIRModule4x16_TopLevel_stages3 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRModule4x16_TopLevel_stages3 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	FIRModule4x16_TopLevel_stages3_dsp : entity work.FIRModule4x16_TopLevel_stages3_dsp
	port map
	(
