...
use work.Quokka.all;
entity FIRModule4x16_TopLevel_stages2 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRModule4x16_TopLevel_stages2 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	FIRModule4x16_TopLevel_stages2_dsp : entity work.FIRModule4x16_TopLevel_stages2_dsp
	port map
	(
