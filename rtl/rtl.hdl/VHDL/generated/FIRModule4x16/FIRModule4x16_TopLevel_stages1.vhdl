...
use work.Quokka.all;
entity FIRModule4x16_TopLevel_stages1 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of FIRModule4x16_TopLevel_stages1 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	FIRModule4x16_TopLevel_stages1_dsp : entity work.FIRModule4x16_TopLevel_stages1_dsp
	port map
	(
