...
--
-- System configuration name is IOTupleStateInternalL1ComponentsOutputModule_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity IOTupleStateInternalL1ComponentsOutputModule_TopLevel is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of IOTupleStateInternalL1ComponentsOutputModule_TopLevel is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal InternalValue_iTuple_Item1 : std_logic := '0';
	signal InternalValue_iTuple_Item2 : unsigned(7 downto 0) := (others => '0');
	signal InternalValue_iTuple_Item4_L1Flag : std_logic := '0';
	signal InternalValue_iTuple_Item4_L2_L2Flag : std_logic := '0';
	signal InternalValue_iTuple_Item4_L2Tuple_Item1 : unsigned(7 downto 0) := (others => '0');
	signal InternalValue_iTuple_Item4_L2Tuple_Item2_L2Flag : std_logic := '0';
	signal IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple : unsigned(59 downto 0) := (others => '0');
	...
	type InternalValue_iTuple_Item3Array is array (0 to 1) of unsigned (3 downto 0);
	signal InternalValue_iTuple_Item3 : InternalValue_iTuple_Item3Array := (others => (others => '0'));
	type InternalValue_iTuple_Item4_L2_L2ValuesArray is array (0 to 1) of std_logic;
	signal InternalValue_iTuple_Item4_L2_L2Values : InternalValue_iTuple_Item4_L2_L2ValuesArray := (others => '0');
	type InternalValue_iTuple_Item4_L2ArrayArray is array (0 to 1) of unsigned (6 downto 0);
	signal InternalValue_iTuple_Item4_L2Array : InternalValue_iTuple_Item4_L2ArrayArray := (others => (others => '0'));
	type InternalValue_iTuple_Item4_L2Tuple_Item2_L2ValuesArray is array (0 to 1) of std_logic;
	signal InternalValue_iTuple_Item4_L2Tuple_Item2_L2Values : InternalValue_iTuple_Item4_L2Tuple_Item2_L2ValuesArray := (others => '0');
	type InternalValue_iTuple_Item4_L2Tuple_Item3Array is array (0 to 1) of unsigned (6 downto 0);
	signal InternalValue_iTuple_Item4_L2Tuple_Item3 : InternalValue_iTuple_Item4_L2Tuple_Item3Array := (others => (others => '0'));
	type InternalValue_iTupleArrayArray is array (0 to 1) of unsigned (53 downto 0);
	signal InternalValue_iTupleArray : InternalValue_iTupleArrayArray := (others => (others => '0'));
begin
	...
	begin
		...
		InternalValue_iTuple_Item1 <= State_Value_iTuple_Item1;
		InternalValue_iTuple_Item2 <= State_Value_iTuple_Item2;
		InternalValue_iTuple_Item3(0) <= State_Value_iTuple_Item3(0);
		InternalValue_iTuple_Item3(1) <= State_Value_iTuple_Item3(1);
		InternalValue_iTuple_Item4_L1Flag <= State_Value_iTuple_Item4_L1Flag;
		InternalValue_iTuple_Item4_L2_L2Flag <= State_Value_iTuple_Item4_L2_L2Flag;
		InternalValue_iTuple_Item4_L2_L2Values(0) <= State_Value_iTuple_Item4_L2_L2Values(0);
		InternalValue_iTuple_Item4_L2_L2Values(1) <= State_Value_iTuple_Item4_L2_L2Values(1);
		InternalValue_iTuple_Item4_L2Array(0) <= State_Value_iTuple_Item4_L2Array(0);
		InternalValue_iTuple_Item4_L2Array(1) <= State_Value_iTuple_Item4_L2Array(1);
		InternalValue_iTuple_Item4_L2Tuple_Item1 <= State_Value_iTuple_Item4_L2Tuple_Item1;
		InternalValue_iTuple_Item4_L2Tuple_Item2_L2Flag <= State_Value_iTuple_Item4_L2Tuple_Item2_L2Flag;
		InternalValue_iTuple_Item4_L2Tuple_Item2_L2Values(0) <= State_Value_iTuple_Item4_L2Tuple_Item2_L2Values(0);
		InternalValue_iTuple_Item4_L2Tuple_Item2_L2Values(1) <= State_Value_iTuple_Item4_L2Tuple_Item2_L2Values(1);
		InternalValue_iTuple_Item4_L2Tuple_Item3(0) <= State_Value_iTuple_Item4_L2Tuple_Item3(0);
		InternalValue_iTuple_Item4_L2Tuple_Item3(1) <= State_Value_iTuple_Item4_L2Tuple_Item3(1);
		InternalValue_iTupleArray(0) <= State_Value_iTupleArray(0);
		InternalValue_iTupleArray(1) <= State_Value_iTupleArray(1);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(59) <= InternalValue_iTuple_Item1;
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(58 downto 51) <= InternalValue_iTuple_Item2;
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(50 downto 47) <= InternalValue_iTuple_Item3(1);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(46 downto 43) <= InternalValue_iTuple_Item3(0);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(42 downto 35) <= InternalValue_iTuple_Item4_L2Tuple_Item1;
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(34) <= InternalValue_iTuple_Item4_L2Tuple_Item2_L2Values(1);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(33) <= InternalValue_iTuple_Item4_L2Tuple_Item2_L2Values(0);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(32) <= InternalValue_iTuple_Item4_L2Tuple_Item2_L2Flag;
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(31 downto 25) <= InternalValue_iTuple_Item4_L2Tuple_Item3(1);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(24 downto 18) <= InternalValue_iTuple_Item4_L2Tuple_Item3(0);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(17 downto 11) <= InternalValue_iTuple_Item4_L2Array(1);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(10 downto 4) <= InternalValue_iTuple_Item4_L2Array(0);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(3) <= InternalValue_iTuple_Item4_L2_L2Values(1);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(2) <= InternalValue_iTuple_Item4_L2_L2Values(0);
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(1) <= InternalValue_iTuple_Item4_L2_L2Flag;
		IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(0) <= InternalValue_iTuple_Item4_L1Flag;
		Output_iTuple_Item1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(59);
		Output_iTuple_Item2 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(58 downto 51);
		Output_iTuple_Item31 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(50 downto 47);
		Output_iTuple_Item30 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(46 downto 43);
		Output_iTuple_Item4_L2Tuple_Item1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(42 downto 35);
		Output_iTuple_Item4_L2Tuple_Item2_L2Values1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(34);
		Output_iTuple_Item4_L2Tuple_Item2_L2Values0 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(33);
		Output_iTuple_Item4_L2Tuple_Item2_L2Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(32);
		Output_iTuple_Item4_L2Tuple_Item31_L2Values1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(31 downto 29);
		Output_iTuple_Item4_L2Tuple_Item31_L2Values0 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(28 downto 26);
		Output_iTuple_Item4_L2Tuple_Item31_L2Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(25);
		Output_iTuple_Item4_L2Tuple_Item30_L2Values1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(24 downto 22);
		Output_iTuple_Item4_L2Tuple_Item30_L2Values0 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(21 downto 19);
		Output_iTuple_Item4_L2Tuple_Item30_L2Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(18);
		Output_iTuple_Item4_L2Array1_L2Values1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(17 downto 15);
		Output_iTuple_Item4_L2Array1_L2Values0 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(14 downto 12);
		Output_iTuple_Item4_L2Array1_L2Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(11);
		Output_iTuple_Item4_L2Array0_L2Values1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(10 downto 8);
		Output_iTuple_Item4_L2Array0_L2Values0 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(7 downto 5);
		Output_iTuple_Item4_L2Array0_L2Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(4);
		Output_iTuple_Item4_L2_L2Values1 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(3);
		Output_iTuple_Item4_L2_L2Values0 <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(2);
		Output_iTuple_Item4_L2_L2Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(1);
		Output_iTuple_Item4_L1Flag <= IOTupleStateInternalL1ComponentsOutputModule_L11F30T50_Tuple(0);
		Output_iTupleArray0_Item1 <= InternalValue_iTupleArray(0)(53);
		Output_iTupleArray0_Item2 <= InternalValue_iTupleArray(0)(52 downto 49);
		Output_iTupleArray0_Item3_L2Tuple_Item1 <= InternalValue_iTupleArray(0)(48 downto 41);
		Output_iTupleArray0_Item3_L2Tuple_Item2_L2Values1 <= InternalValue_iTupleArray(0)(40);
		Output_iTupleArray0_Item3_L2Tuple_Item2_L2Values0 <= InternalValue_iTupleArray(0)(39);
		Output_iTupleArray0_Item3_L2Tuple_Item2_L2Flag <= InternalValue_iTupleArray(0)(38);
		Output_iTupleArray0_Item3_L2Tuple_Item31_L2Values1 <= InternalValue_iTupleArray(0)(37 downto 35);
		Output_iTupleArray0_Item3_L2Tuple_Item31_L2Values0 <= InternalValue_iTupleArray(0)(34 downto 32);
		Output_iTupleArray0_Item3_L2Tuple_Item31_L2Flag <= InternalValue_iTupleArray(0)(31);
		Output_iTupleArray0_Item3_L2Tuple_Item30_L2Values1 <= InternalValue_iTupleArray(0)(30 downto 28);
		Output_iTupleArray0_Item3_L2Tuple_Item30_L2Values0 <= InternalValue_iTupleArray(0)(27 downto 25);
		Output_iTupleArray0_Item3_L2Tuple_Item30_L2Flag <= InternalValue_iTupleArray(0)(24);
		Output_iTupleArray0_Item3_L2Array1_L2Values1 <= InternalValue_iTupleArray(0)(23 downto 21);
		Output_iTupleArray0_Item3_L2Array1_L2Values0 <= InternalValue_iTupleArray(0)(20 downto 18);
		Output_iTupleArray0_Item3_L2Array1_L2Flag <= InternalValue_iTupleArray(0)(17);
		Output_iTupleArray0_Item3_L2Array0_L2Values1 <= InternalValue_iTupleArray(0)(16 downto 14);
		Output_iTupleArray0_Item3_L2Array0_L2Values0 <= InternalValue_iTupleArray(0)(13 downto 11);
		Output_iTupleArray0_Item3_L2Array0_L2Flag <= InternalValue_iTupleArray(0)(10);
		Output_iTupleArray0_Item3_L2_L2Values1 <= InternalValue_iTupleArray(0)(9);
		Output_iTupleArray0_Item3_L2_L2Values0 <= InternalValue_iTupleArray(0)(8);
		Output_iTupleArray0_Item3_L2_L2Flag <= InternalValue_iTupleArray(0)(7);
		Output_iTupleArray0_Item3_L1Flag <= InternalValue_iTupleArray(0)(6);
		Output_iTupleArray0_Item41_L2Values1 <= InternalValue_iTupleArray(0)(5);
		Output_iTupleArray0_Item41_L2Values0 <= InternalValue_iTupleArray(0)(4);
		Output_iTupleArray0_Item41_L2Flag <= InternalValue_iTupleArray(0)(3);
		Output_iTupleArray0_Item40_L2Values1 <= InternalValue_iTupleArray(0)(2);
		Output_iTupleArray0_Item40_L2Values0 <= InternalValue_iTupleArray(0)(1);
		Output_iTupleArray0_Item40_L2Flag <= InternalValue_iTupleArray(0)(0);
		Output_iTupleArray1_Item1 <= InternalValue_iTupleArray(1)(53);
		Output_iTupleArray1_Item2 <= InternalValue_iTupleArray(1)(52 downto 49);
		Output_iTupleArray1_Item3_L2Tuple_Item1 <= InternalValue_iTupleArray(1)(48 downto 41);
		Output_iTupleArray1_Item3_L2Tuple_Item2_L2Values1 <= InternalValue_iTupleArray(1)(40);
		Output_iTupleArray1_Item3_L2Tuple_Item2_L2Values0 <= InternalValue_iTupleArray(1)(39);
		Output_iTupleArray1_Item3_L2Tuple_Item2_L2Flag <= InternalValue_iTupleArray(1)(38);
		Output_iTupleArray1_Item3_L2Tuple_Item31_L2Values1 <= InternalValue_iTupleArray(1)(37 downto 35);
		Output_iTupleArray1_Item3_L2Tuple_Item31_L2Values0 <= InternalValue_iTupleArray(1)(34 downto 32);
		Output_iTupleArray1_Item3_L2Tuple_Item31_L2Flag <= InternalValue_iTupleArray(1)(31);
		Output_iTupleArray1_Item3_L2Tuple_Item30_L2Values1 <= InternalValue_iTupleArray(1)(30 downto 28);
		Output_iTupleArray1_Item3_L2Tuple_Item30_L2Values0 <= InternalValue_iTupleArray(1)(27 downto 25);
		Output_iTupleArray1_Item3_L2Tuple_Item30_L2Flag <= InternalValue_iTupleArray(1)(24);
		Output_iTupleArray1_Item3_L2Array1_L2Values1 <= InternalValue_iTupleArray(1)(23 downto 21);
		Output_iTupleArray1_Item3_L2Array1_L2Values0 <= InternalValue_iTupleArray(1)(20 downto 18);
		Output_iTupleArray1_Item3_L2Array1_L2Flag <= InternalValue_iTupleArray(1)(17);
		Output_iTupleArray1_Item3_L2Array0_L2Values1 <= InternalValue_iTupleArray(1)(16 downto 14);
		Output_iTupleArray1_Item3_L2Array0_L2Values0 <= InternalValue_iTupleArray(1)(13 downto 11);
		Output_iTupleArray1_Item3_L2Array0_L2Flag <= InternalValue_iTupleArray(1)(10);
		Output_iTupleArray1_Item3_L2_L2Values1 <= InternalValue_iTupleArray(1)(9);
		Output_iTupleArray1_Item3_L2_L2Values0 <= InternalValue_iTupleArray(1)(8);
		Output_iTupleArray1_Item3_L2_L2Flag <= InternalValue_iTupleArray(1)(7);
		Output_iTupleArray1_Item3_L1Flag <= InternalValue_iTupleArray(1)(6);
		Output_iTupleArray1_Item41_L2Values1 <= InternalValue_iTupleArray(1)(5);
		Output_iTupleArray1_Item41_L2Values0 <= InternalValue_iTupleArray(1)(4);
		Output_iTupleArray1_Item41_L2Flag <= InternalValue_iTupleArray(1)(3);
		Output_iTupleArray1_Item40_L2Values1 <= InternalValue_iTupleArray(1)(2);
		Output_iTupleArray1_Item40_L2Values0 <= InternalValue_iTupleArray(1)(1);
		Output_iTupleArray1_Item40_L2Flag <= InternalValue_iTupleArray(1)(0);
	end process;
