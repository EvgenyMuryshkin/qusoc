...
--
-- System configuration name is GenerateModule4_TopLevel_nested4, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity GenerateModule4_TopLevel_nested4 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		iData : in unsigned (4 downto 0);
		iBit : in std_logic;
		oData : out unsigned (5 downto 0);
		oBit : out std_logic
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of GenerateModule4_TopLevel_nested4 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal Inputs_iData : unsigned(4 downto 0) := (others => '0');
	...
	signal GenerateModule_L40F37T68_Expr : unsigned(6 downto 0) := "0000000";
	signal GenerateModule_L40F37T68_Expr_1 : unsigned(6 downto 0) := "0000000";
	signal GenerateModule_L40F37T68_Expr_2 : unsigned(6 downto 0) := "0000000";
	signal GenerateModule_L40F37T54_Expr : unsigned(6 downto 0) := "0000000";
	signal GenerateModule_L40F37T54_Expr_1 : unsigned(6 downto 0) := "0000000";
begin
	...
	GenerateModule4_TopLevel_nested4_inverter : entity work.GenerateModule4_TopLevel_nested4_inverter
	port map
	(
...
outValue => inverteroutValueinverter_outValueHardLink
	...
	begin
		...
		GenerateModule_L40F37T68_Expr_2(6 downto 1) <= (others => '0');
		GenerateModule_L40F37T68_Expr_2(0) <= Inputs_iBit;
		GenerateModule_L40F37T54_Expr_1(6 downto 5) <= (others => '0');
		GenerateModule_L40F37T54_Expr_1(4 downto 0) <= Inputs_iData;
		Inputs_iData <= iData;
		Inputs_iBit <= iBit;
		inverter_inValue <= Inputs_iBit;
		oData <= GenerateModule_L40F37T68_Expr(5 downto 0);
