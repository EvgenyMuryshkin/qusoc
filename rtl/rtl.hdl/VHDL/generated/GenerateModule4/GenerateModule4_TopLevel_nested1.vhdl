...
use work.Quokka.all;
entity GenerateModule4_TopLevel_nested1 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		iData : in unsigned (1 downto 0);
		iBit : in std_logic;
		oData : out unsigned (2 downto 0);
		oBit : out std_logic
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of GenerateModule4_TopLevel_nested1 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal Inputs_iData : unsigned(1 downto 0) := (others => '0');
	...
	signal GenerateModule_L40F37T68_Expr : unsigned(3 downto 0) := "0000";
	signal GenerateModule_L40F37T68_Expr_1 : unsigned(3 downto 0) := "0000";
	signal GenerateModule_L40F37T68_Expr_2 : unsigned(3 downto 0) := "0000";
	signal GenerateModule_L40F37T54_Expr : unsigned(3 downto 0) := "0000";
	signal GenerateModule_L40F37T54_Expr_1 : unsigned(3 downto 0) := "0000";
begin
	...
	GenerateModule4_TopLevel_nested1_inverter : entity work.GenerateModule4_TopLevel_nested1_inverter
	port map
	(
...
outValue => inverteroutValueinverter_outValueHardLink
	...
	begin
		...
		GenerateModule_L40F37T68_Expr_2(3 downto 1) <= (others => '0');
		GenerateModule_L40F37T68_Expr_2(0) <= Inputs_iBit;
		GenerateModule_L40F37T54_Expr_1(3 downto 2) <= (others => '0');
		GenerateModule_L40F37T54_Expr_1(1 downto 0) <= Inputs_iData;
		Inputs_iData <= iData;
		Inputs_iBit <= iBit;
		inverter_inValue <= Inputs_iBit;
		oData <= GenerateModule_L40F37T68_Expr(2 downto 0);
