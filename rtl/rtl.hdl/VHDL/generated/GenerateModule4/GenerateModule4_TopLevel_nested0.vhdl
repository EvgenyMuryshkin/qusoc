...
use work.Quokka.all;
entity GenerateModule4_TopLevel_nested0 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		iData : in std_logic;
		iBit : in std_logic;
		oData : out unsigned (1 downto 0);
		oBit : out std_logic
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of GenerateModule4_TopLevel_nested0 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal Inputs_iData : std_logic := '0';
	...
	signal GenerateModule_L40F37T68_Expr : unsigned(2 downto 0) := "000";
	signal GenerateModule_L40F37T68_Expr_1 : unsigned(2 downto 0) := "000";
	signal GenerateModule_L40F37T68_Expr_2 : unsigned(2 downto 0) := "000";
	signal GenerateModule_L40F37T54_Expr : unsigned(2 downto 0) := "000";
	signal GenerateModule_L40F37T54_Expr_1 : unsigned(2 downto 0) := "000";
begin
	...
	GenerateModule4_TopLevel_nested0_inverter : entity work.GenerateModule4_TopLevel_nested0_inverter
	port map
	(
...
outValue => inverteroutValueinverter_outValueHardLink
	...
	begin
		...
		GenerateModule_L40F37T68_Expr_2(2 downto 1) <= (others => '0');
		GenerateModule_L40F37T68_Expr_2(0) <= Inputs_iBit;
		GenerateModule_L40F37T54_Expr_1(2 downto 1) <= (others => '0');
		GenerateModule_L40F37T54_Expr_1(0) <= Inputs_iData;
		Inputs_iData <= iData;
		Inputs_iBit <= iBit;
		inverter_inValue <= Inputs_iBit;
		oData <= GenerateModule_L40F37T68_Expr(1 downto 0);
