...
use work.Quokka.all;
entity AXI4RegisterModuleB4_TopLevel_AXI4RegisterModuleB4_axiSlave is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		...
		RDATA0 : in unsigned (7 downto 0);
		RDATA1 : in unsigned (7 downto 0);
		RDATA2 : in unsigned (7 downto 0);
		RDATA3 : in unsigned (7 downto 0);
		RACK : in std_logic;
		WACK : in std_logic;
		...
		WSTRB : out unsigned (3 downto 0);
		WDATA0 : out unsigned (7 downto 0);
		WDATA1 : out unsigned (7 downto 0);
		WDATA2 : out unsigned (7 downto 0);
		WDATA3 : out unsigned (7 downto 0);
		WVALID : out std_logic;
		RVALID : out std_logic;
		ARADDR : out unsigned (31 downto 0);
		AWADDR : out unsigned (31 downto 0)
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of AXI4RegisterModuleB4_TopLevel_AXI4RegisterModuleB4_axiSlave is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	type Inputs_RDATAArray is array (0 to 3) of unsigned (7 downto 0);
	signal Inputs_RDATA : Inputs_RDATAArray := (others => (others => '0'));
begin
	...
	begin
		...
		if AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L86F17L90T23_Case = '1' then
			...
			NextState_readFSM(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L87F17L89T18_AXI4NonBufferedSlaveModule_L88F41T61_Expr;
			...
			if AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L100F17L103T18_AXI4NonBufferedSlaveModule_L101F25T59_Expr = '1' then
				NextState_readFSM(1) <= '0';
				NextState_readFSM(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L100F17L103T18_AXI4NonBufferedSlaveModule_L102F45T65_Expr;
			end if;
		else
			NextState_readFSM(1) <= '0';
			NextState_readFSM(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L106F17L108T18_AXI4NonBufferedSlaveModule_L107F41T61_Expr;
		end if;
		if AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L114F17L118T23_Case = '1' then
			...
			NextState_writeFSM(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L115F17L117T18_AXI4NonBufferedSlaveModule_L116F42T63_Expr;
			...
			if AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L126F17L129T18_AXI4NonBufferedSlaveModule_L127F25T59_Expr = '1' then
				NextState_writeFSM(1) <= '0';
				NextState_writeFSM(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L126F17L129T18_AXI4NonBufferedSlaveModule_L128F46T67_Expr;
			end if;
		else
			NextState_writeFSM(1) <= '0';
			NextState_writeFSM(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L132F17L134T18_AXI4NonBufferedSlaveModule_L133F42T63_Expr;
		end if;
	end process;
	process (AXI4NonBufferedSlaveModule_L42F27T64_Expr, AXI4NonBufferedSlaveModule_L48F26T61_Expr, AXI4NonBufferedSlaveModule_L48F26T76_Expr, AXI4NonBufferedSlaveModule_L54F27T66_Expr, AXI4NonBufferedSlaveModule_L58F26T65_Expr, AXI4NonBufferedSlaveModule_L58F26T80_Expr, AXI4NonBufferedSlaveModule_L65F26T63_Expr, AXI4NonBufferedSlaveModule_L69F23T67_Expr, axiRE, axiWE, Inputs_M2S_AR_ARADDR, Inputs_M2S_AR_ARID, Inputs_M2S_AR_ARUSER, Inputs_M2S_AR_ARVALID, Inputs_M2S_AW_AWADDR, Inputs_M2S_AW_AWVALID, Inputs_M2S_B_BREADY, Inputs_M2S_R_RREADY, Inputs_M2S_W_WDATA, Inputs_M2S_W_WID, Inputs_M2S_W_WSTRB, Inputs_M2S_W_WUSER, Inputs_M2S_W_WVALID, Inputs_RACK, Inputs_RDATA, Inputs_WACK, M2S_AR_ARADDR, M2S_AR_ARBURST, M2S_AR_ARCACHE, M2S_AR_ARID, M2S_AR_ARLEN, M2S_AR_ARLOCK, M2S_AR_ARPROT, M2S_AR_ARQOS, M2S_AR_ARREGION, M2S_AR_ARSIZE, M2S_AR_ARUSER, M2S_AR_ARVALID, M2S_AW_AWADDR, M2S_AW_AWBURST, M2S_AW_AWCACHE, M2S_AW_AWID, M2S_AW_AWLEN, M2S_AW_AWLOCK, M2S_AW_AWPROT, M2S_AW_AWQOS, M2S_AW_AWREGION, M2S_AW_AWSIZE, M2S_AW_AWUSER, M2S_AW_AWVALID, M2S_B_BREADY, M2S_R_RREADY, M2S_W_WDATA0, M2S_W_WDATA1, M2S_W_WDATA2, M2S_W_WDATA3, M2S_W_WID, M2S_W_WLAST, M2S_W_WSTRB, M2S_W_WUSER, M2S_W_WVALID, RACK, RDATA0, RDATA1, RDATA2, RDATA3, State_readFSM, State_writeFSM, WACK)
	begin
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L86F17L90T23_CaseLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L86F17L90T23_CaseLhs(1 downto 0) <= signed(State_readFSM);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L86F17L90T23_CaseRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L86F17L90T23_CaseRhs(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L86F22T43_Expr;
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L91F17L98T23_CaseLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L91F17L98T23_CaseLhs(1 downto 0) <= signed(State_readFSM);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L91F17L98T23_CaseRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L91F17L98T23_CaseRhs(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L91F22T42_Expr;
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L99F17L104T23_CaseLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L99F17L104T23_CaseLhs(1 downto 0) <= signed(State_readFSM);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L99F17L104T23_CaseRhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L99F17L104T23_CaseRhs(1 downto 0) <= signed(AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L84F13L110T14_AXI4NonBufferedSlaveModule_L99F22T40_Expr);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L114F17L118T23_CaseLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L114F17L118T23_CaseLhs(1 downto 0) <= signed(State_writeFSM);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L114F17L118T23_CaseRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L114F17L118T23_CaseRhs(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L114F22T44_Expr;
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L119F17L124T23_CaseLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L119F17L124T23_CaseLhs(1 downto 0) <= signed(State_writeFSM);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L119F17L124T23_CaseRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L119F17L124T23_CaseRhs(0) <= AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L119F22T43_Expr;
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L125F17L130T23_CaseLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L125F17L130T23_CaseLhs(1 downto 0) <= signed(State_writeFSM);
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L125F17L130T23_CaseRhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L125F17L130T23_CaseRhs(1 downto 0) <= signed(AXI4NonBufferedSlaveModule_L81F9L137T10_AXI4NonBufferedSlaveModule_L112F13L136T14_AXI4NonBufferedSlaveModule_L125F22T41_Expr);
		AXI4NonBufferedSlaveModule_L42F27T64_ExprLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L42F27T64_ExprLhs(1 downto 0) <= signed(State_readFSM);
		AXI4NonBufferedSlaveModule_L42F27T64_ExprRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L42F27T64_ExprRhs(0) <= AXI4NonBufferedSlaveModule_L42F44T64_Expr;
		AXI4NonBufferedSlaveModule_L48F26T61_ExprLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L48F26T61_ExprLhs(1 downto 0) <= signed(State_readFSM);
		AXI4NonBufferedSlaveModule_L48F26T61_ExprRhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L48F26T61_ExprRhs(1 downto 0) <= signed(AXI4NonBufferedSlaveModule_L48F43T61_Expr);
		AXI4NonBufferedSlaveModule_L54F27T66_ExprLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L54F27T66_ExprLhs(1 downto 0) <= signed(State_writeFSM);
		AXI4NonBufferedSlaveModule_L54F27T66_ExprRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L54F27T66_ExprRhs(0) <= AXI4NonBufferedSlaveModule_L54F45T66_Expr;
		AXI4NonBufferedSlaveModule_L58F26T65_ExprLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L58F26T65_ExprLhs(1 downto 0) <= signed(State_writeFSM);
		AXI4NonBufferedSlaveModule_L58F26T65_ExprRhs(2 downto 1) <= (others => '0');
		AXI4NonBufferedSlaveModule_L58F26T65_ExprRhs(0) <= AXI4NonBufferedSlaveModule_L58F44T65_Expr;
		AXI4NonBufferedSlaveModule_L65F26T63_ExprLhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L65F26T63_ExprLhs(1 downto 0) <= signed(State_writeFSM);
		AXI4NonBufferedSlaveModule_L65F26T63_ExprRhs(2) <= '0';
		AXI4NonBufferedSlaveModule_L65F26T63_ExprRhs(1 downto 0) <= signed(AXI4NonBufferedSlaveModule_L65F44T63_Expr);
		...
		Inputs_RDATA(0) <= RDATA0;
		Inputs_RDATA(1) <= RDATA1;
		Inputs_RDATA(2) <= RDATA2;
		Inputs_RDATA(3) <= RDATA3;
		Inputs_RACK <= RACK;
		Inputs_WACK <= WACK;
		...
		S2M_B_BRESP(1) <= '0';
		S2M_B_BRESP(0) <= AXI4NonBufferedSlaveModule_L63F25T37_Expr;
		S2M_B_BUSER <= Inputs_M2S_W_WUSER;
		S2M_B_BVALID <= AXI4NonBufferedSlaveModule_L65F26T63_Expr;
		S2M_R_RID <= Inputs_M2S_AR_ARID;
		S2M_R_RDATA0 <= Inputs_RDATA(0);
		S2M_R_RDATA1 <= Inputs_RDATA(1);
		S2M_R_RDATA2 <= Inputs_RDATA(2);
		S2M_R_RDATA3 <= Inputs_RDATA(3);
		S2M_R_RRESP(1) <= '0';
		S2M_R_RRESP(0) <= AXI4NonBufferedSlaveModule_L50F25T37_Expr;
		...
		WDATA0 <= Inputs_M2S_W_WDATA(0);
		WDATA1 <= Inputs_M2S_W_WDATA(1);
		WDATA2 <= Inputs_M2S_W_WDATA(2);
		WDATA3 <= Inputs_M2S_W_WDATA(3);
		WVALID <= axiWE;
		RVALID <= axiRE;
