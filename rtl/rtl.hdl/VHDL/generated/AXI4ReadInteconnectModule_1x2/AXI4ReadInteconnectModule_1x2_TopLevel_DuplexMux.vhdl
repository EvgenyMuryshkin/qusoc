...
use work.Quokka.all;
entity AXI4ReadInteconnectModule_1x2_TopLevel_DuplexMux is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4ReadInteconnectModule_1x2_TopLevel_DuplexMux is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	type mOutRightDataArray is array (0 to 0) of unsigned (52 downto 0);
