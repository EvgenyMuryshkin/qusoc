...
--
-- System configuration name is AXI4ReadInteconnectModule_1x2_TopLevel_rangeDetectorArray0_rangeDetectors1, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4ReadInteconnectModule_1x2_TopLevel_rangeDetectorArray0_rangeDetectors1 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4ReadInteconnectModule_1x2_TopLevel_rangeDetectorArray0_rangeDetectors1 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
