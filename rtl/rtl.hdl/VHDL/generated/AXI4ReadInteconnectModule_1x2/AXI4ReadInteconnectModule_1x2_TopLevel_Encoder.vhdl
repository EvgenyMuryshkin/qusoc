...
--
-- System configuration name is AXI4ReadInteconnectModule_1x2_TopLevel_Encoder, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4ReadInteconnectModule_1x2_TopLevel_Encoder is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		...
		MSBValue : out std_logic
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of AXI4ReadInteconnectModule_1x2_TopLevel_Encoder is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal AXI4EncoderModule_L59F40T101_ShiftLeft : std_logic := '0';
	signal AXI4EncoderModule_L59F40T121_Resize : std_logic := '0';
	signal AXI4EncoderModule_L59F40T101_Expr : std_logic := '0';
	signal AXI4EncoderModule_L59F40T101_Expr_1 : std_logic := '0';
...
begin
	...
	begin
		AXI4EncoderModule_L59F40T101_Expr <= shift_left(AXI4EncoderModule_L59F40T101_Expr_1, bit_to_integer(internalEncoded));
	end process;
