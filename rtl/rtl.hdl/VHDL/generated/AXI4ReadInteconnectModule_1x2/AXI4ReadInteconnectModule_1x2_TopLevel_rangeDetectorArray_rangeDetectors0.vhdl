...
use work.Quokka.all;
entity AXI4ReadInteconnectModule_1x2_TopLevel_rangeDetectorArray_rangeDetectors0 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4ReadInteconnectModule_1x2_TopLevel_rangeDetectorArray_rangeDetectors0 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
