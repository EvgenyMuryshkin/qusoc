...
--
-- System configuration name is AXI4Interconnect2x4Module_TopLevel_masterReadEncoderModule, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4Interconnect2x4Module_TopLevel_masterReadEncoderModule is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4Interconnect2x4Module_TopLevel_masterReadEncoderModule is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
