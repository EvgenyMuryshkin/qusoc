...
--
-- System configuration name is ModuleSignalsMuxModule_TopLevel_XorGate, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity ModuleSignalsMuxModule_TopLevel_XorGate is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of ModuleSignalsMuxModule_TopLevel_XorGate is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
