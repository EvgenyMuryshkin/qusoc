...
--
-- System configuration name is AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_mem, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_mem is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_mem is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal internalRADDR_reg0 : unsigned(7 downto 0);
	signal internalRADDR_reg1 : unsigned(7 downto 0);
	signal internalRADDR_reg2 : unsigned(7 downto 0);
	signal internalRADDR_reg3 : unsigned(7 downto 0);
begin
	process (BoardSignals, NextState_raddr, NextState_waddr, NextState_waddrSet, NextState_wdataSet, NextState_wstrb)
	begin
	...
	process (BoardSignals, NextState_wdata, State_wdataDefault)
	begin
		if rising_edge(BoardSignals.Clock) then
			if BoardSignals.Reset = '1' then
	...
	AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_mem_AXI4MemoryModule_axiSlave : entity work.AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_mem_AXI4MemoryModule_axiSlave
	port map
	(
...
outWSTRB => axiSlaveoutWSTRBaxiSlave_outWSTRBHardLink
	...
	process (BoardSignals.Clock, AXI4MemoryModule_L104F9L136T10_AXI4MemoryModule_L124F13L128T14_0_AXI4MemoryModule_L125F13L128T14_AXI4MemoryModule_L126F21T51_Expr, internalWADDR, internalWDATA, internalRADDR_reg0, State_buff0, internalRADDR)
	begin
		if rising_edge(BoardSignals.Clock) then
			...
			internalRADDR_reg0 <= internalRADDR;
		end if;
		State_rdata(0) <= State_buff0(TO_INTEGER(internalRADDR_reg0));
	end process;
	-- inferred simple dual port RAM with write-first behaviour
	process (BoardSignals.Clock, AXI4MemoryModule_L104F9L136T10_AXI4MemoryModule_L124F13L128T14_1_AXI4MemoryModule_L125F13L128T14_AXI4MemoryModule_L126F21T51_Expr, internalWADDR, internalWDATA, internalRADDR_reg1, State_buff1, internalRADDR)
	begin
		if rising_edge(BoardSignals.Clock) then
			...
			internalRADDR_reg1 <= internalRADDR;
		end if;
		State_rdata(1) <= State_buff1(TO_INTEGER(internalRADDR_reg1));
	end process;
	-- inferred simple dual port RAM with write-first behaviour
	process (BoardSignals.Clock, AXI4MemoryModule_L104F9L136T10_AXI4MemoryModule_L124F13L128T14_2_AXI4MemoryModule_L125F13L128T14_AXI4MemoryModule_L126F21T51_Expr, internalWADDR, internalWDATA, internalRADDR_reg2, State_buff2, internalRADDR)
	begin
		if rising_edge(BoardSignals.Clock) then
			...
			internalRADDR_reg2 <= internalRADDR;
		end if;
		State_rdata(2) <= State_buff2(TO_INTEGER(internalRADDR_reg2));
	end process;
	-- inferred simple dual port RAM with write-first behaviour
	process (BoardSignals.Clock, AXI4MemoryModule_L104F9L136T10_AXI4MemoryModule_L124F13L128T14_3_AXI4MemoryModule_L125F13L128T14_AXI4MemoryModule_L126F21T51_Expr, internalWADDR, internalWDATA, internalRADDR_reg3, State_buff3, internalRADDR)
	begin
		if rising_edge(BoardSignals.Clock) then
			...
			internalRADDR_reg3 <= internalRADDR;
		end if;
