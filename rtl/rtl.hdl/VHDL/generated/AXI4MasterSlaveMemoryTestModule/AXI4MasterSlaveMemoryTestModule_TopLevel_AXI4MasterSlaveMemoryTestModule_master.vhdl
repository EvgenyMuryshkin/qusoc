...
--
-- System configuration name is AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_master, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_master is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4MasterSlaveMemoryTestModule_TopLevel_AXI4MasterSlaveMemoryTestModule_master is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	begin
		...
		M2S_AR_ARID(0) <= AXI4_M_AR_L15F28T29_Expr;
		M2S_AR_ARADDR <= Inputs_ARADDR;
		M2S_AR_ARLEN(7 downto 1) <= (others => '0');
		M2S_AR_ARLEN(0) <= AXI4_M_AR_L17F29T30_Expr;
		M2S_AR_ARSIZE(2) <= '0';
		M2S_AR_ARSIZE(1 downto 0) <= AXI4_M_AR_L18F33T43_Expr;
		M2S_AR_ARBURST(1) <= '0';
		M2S_AR_ARBURST(0) <= AXI4_M_AR_L19F35T48_Expr;
		M2S_AR_ARLOCK(1) <= '0';
		M2S_AR_ARLOCK(0) <= AXI4_M_AR_L20F33T47_Expr;
		M2S_AR_ARCACHE(3 downto 1) <= (others => '0');
		M2S_AR_ARCACHE(0) <= AXI4_M_AR_L21F35T63_Expr;
		M2S_AR_ARPROT(2) <= '0';
		M2S_AR_ARPROT(1 downto 0) <= AXI4_M_AR_L22F33T66_Expr;
		M2S_AR_ARQOS(3 downto 1) <= (others => '0');
		M2S_AR_ARQOS(0) <= AXI4_M_AR_L23F31T44_Expr;
		M2S_AR_ARREGION(7 downto 1) <= (others => '0');
		M2S_AR_ARREGION(0) <= AXI4_M_AR_L24F32T33_Expr;
		M2S_AR_ARUSER(7 downto 1) <= (others => '0');
		M2S_AR_ARUSER(0) <= AXI4_M_AR_L25F30T31_Expr;
		M2S_AR_ARVALID <= Inputs_RE;
		M2S_R_RREADY <= AXI4MasterModule_L73F26T30_Expr;
		M2S_AW_AWID(7 downto 1) <= (others => '0');
		M2S_AW_AWID(0) <= AXI4_M_AW_L14F28T29_Expr;
		M2S_AW_AWADDR <= Inputs_AWADDR;
		M2S_AW_AWLEN(7 downto 1) <= (others => '0');
		M2S_AW_AWLEN(0) <= AXI4_M_AW_L16F29T30_Expr;
		M2S_AW_AWSIZE(2) <= '0';
		M2S_AW_AWSIZE(1 downto 0) <= AXI4_M_AW_L17F33T43_Expr;
		M2S_AW_AWBURST(1) <= '0';
		M2S_AW_AWBURST(0) <= AXI4_M_AW_L18F35T48_Expr;
		M2S_AW_AWLOCK(1) <= '0';
		M2S_AW_AWLOCK(0) <= AXI4_M_AW_L19F33T47_Expr;
		M2S_AW_AWCACHE(3 downto 1) <= (others => '0');
		M2S_AW_AWCACHE(0) <= AXI4_M_AW_L20F35T63_Expr;
		M2S_AW_AWPROT(2) <= '0';
		M2S_AW_AWPROT(1 downto 0) <= AXI4_M_AW_L21F33T66_Expr;
		M2S_AW_AWQOS(3 downto 1) <= (others => '0');
		M2S_AW_AWQOS(0) <= AXI4_M_AW_L22F31T44_Expr;
		M2S_AW_AWREGION(7 downto 1) <= (others => '0');
		M2S_AW_AWREGION(0) <= AXI4_M_AW_L23F32T33_Expr;
		M2S_AW_AWUSER(7 downto 1) <= (others => '0');
		M2S_AW_AWUSER(0) <= AXI4_M_AW_L24F30T31_Expr;
		...
		M2S_W_WUSER(0) <= AXI4_M_W_L18F29T30_Expr;
