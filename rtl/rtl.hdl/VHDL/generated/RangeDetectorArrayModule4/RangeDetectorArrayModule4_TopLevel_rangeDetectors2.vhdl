...
--
-- System configuration name is RangeDetectorArrayModule4_TopLevel_rangeDetectors2, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity RangeDetectorArrayModule4_TopLevel_rangeDetectors2 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of RangeDetectorArrayModule4_TopLevel_rangeDetectors2 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	constant rangeFrom : unsigned(29 downto 0) := "100000000000000000000000000000";
	constant rangeTo : unsigned(30 downto 0) := "1101111111111111111111111111111";
...
begin
	...
	begin
		...
		RangeDetectorModule_L34F33T58_ExprRhs(32 downto 30) <= (others => '0');
		RangeDetectorModule_L34F33T58_ExprRhs(29 downto 0) <= signed(rangeFrom);
		RangeDetectorModule_L34F62T85_ExprLhs(32) <= '0';
		RangeDetectorModule_L34F62T85_ExprLhs(31 downto 0) <= signed(Inputs_Value);
		RangeDetectorModule_L34F62T85_ExprRhs(32 downto 31) <= (others => '0');
		RangeDetectorModule_L34F62T85_ExprRhs(30 downto 0) <= signed(rangeTo);
