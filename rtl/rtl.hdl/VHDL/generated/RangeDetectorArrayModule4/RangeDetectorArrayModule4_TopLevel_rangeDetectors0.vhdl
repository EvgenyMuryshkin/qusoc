...
--
-- System configuration name is RangeDetectorArrayModule4_TopLevel_rangeDetectors0, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity RangeDetectorArrayModule4_TopLevel_rangeDetectors0 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of RangeDetectorArrayModule4_TopLevel_rangeDetectors0 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
