...
use work.Quokka.all;
entity RangeDetectorArrayModule4_TopLevel_encoder is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of RangeDetectorArrayModule4_TopLevel_encoder is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	constant inputWidth : unsigned(2 downto 0) := "111";
