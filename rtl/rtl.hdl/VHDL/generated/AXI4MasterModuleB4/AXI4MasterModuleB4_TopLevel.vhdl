...
begin
process (Clock, NextState_AXADDR, NextState_fsm, NextState_WSTRB, Reset)
begin
...
process (Clock, NextState_ARDATA, Reset, State_ARDATADefault)
begin
if rising_edge(Clock) then
if ( Reset = '1' ) then
...
process (Clock, NextState_AWDATA, Reset, State_AWDATADefault)
begin
if rising_edge(Clock) then
if ( Reset = '1' ) then
...
M2S_AR_ARID <= (0 => AXI4_M_AR_L15F28T29_Expr, others => '0');
M2S_AR_ARADDR <= State_AXADDR;
M2S_AR_ARLEN <= (0 => AXI4_M_AR_L17F29T30_Expr, others => '0');
M2S_AR_ARSIZE <= unsigned(resize(unsigned(AXI4_M_AR_L18F33T43_Expr), M2S_AR_ARSIZE'length));
M2S_AR_ARBURST <= (0 => AXI4_M_AR_L19F35T48_Expr, others => '0');
M2S_AR_ARLOCK <= (0 => AXI4_M_AR_L20F33T47_Expr, others => '0');
M2S_AR_ARCACHE <= (0 => AXI4_M_AR_L21F35T63_Expr, others => '0');
M2S_AR_ARPROT <= unsigned(resize(unsigned(AXI4_M_AR_L22F33T66_Expr), M2S_AR_ARPROT'length));
M2S_AR_ARQOS <= (0 => AXI4_M_AR_L23F31T44_Expr, others => '0');
M2S_AR_ARREGION <= (0 => AXI4_M_AR_L24F32T33_Expr, others => '0');
M2S_AR_ARUSER <= (0 => AXI4_M_AR_L25F30T31_Expr, others => '0');
M2S_AR_ARVALID <= AXI4MasterModule_L62F27T58_Expr;
M2S_R_RREADY <= AXI4MasterModule_L66F26T56_Expr;
M2S_AW_AWID <= (0 => AXI4_M_AW_L14F28T29_Expr, others => '0');
M2S_AW_AWADDR <= State_AXADDR;
M2S_AW_AWLEN <= (0 => AXI4_M_AW_L16F29T30_Expr, others => '0');
M2S_AW_AWSIZE <= unsigned(resize(unsigned(AXI4_M_AW_L17F33T43_Expr), M2S_AW_AWSIZE'length));
M2S_AW_AWBURST <= (0 => AXI4_M_AW_L18F35T48_Expr, others => '0');
M2S_AW_AWLOCK <= (0 => AXI4_M_AW_L19F33T47_Expr, others => '0');
M2S_AW_AWCACHE <= (0 => AXI4_M_AW_L20F35T63_Expr, others => '0');
M2S_AW_AWPROT <= unsigned(resize(unsigned(AXI4_M_AW_L21F33T66_Expr), M2S_AW_AWPROT'length));
M2S_AW_AWQOS <= (0 => AXI4_M_AW_L22F31T44_Expr, others => '0');
M2S_AW_AWREGION <= (0 => AXI4_M_AW_L23F32T33_Expr, others => '0');
M2S_AW_AWUSER <= (0 => AXI4_M_AW_L24F30T31_Expr, others => '0');
M2S_AW_AWVALID <= AXI4MasterModule_L71F27T58_Expr;
M2S_W_WID <= (0 => AXI4MasterModule_L75F23T24_Expr, others => '0');
...
M2S_W_WUSER <= (0 => AXI4_M_W_L18F29T30_Expr, others => '0');
