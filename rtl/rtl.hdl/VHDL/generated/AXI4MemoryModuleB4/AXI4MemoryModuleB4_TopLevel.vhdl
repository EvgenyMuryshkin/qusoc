...
architecture rtl of AXI4MemoryModuleB4_TopLevel is
	...
	signal AXI4MemoryModule_L91F37L100T14_Object : unsigned(258 downto 0) := (others => '0');
	...
	signal AXI4MemoryModule_L64F37T85_Expr : std_logic := '0';
	signal AXI4MemoryModule_L64F37T85_Expr_1 : std_logic := '0';
	signal AXI4MemoryModule_L64F37T85_Expr_2 : std_logic := '0';
...
begin
	...
	process (AXI4MemoryModule_L64F37T85_Expr_1, AXI4MemoryModule_L64F37T85_Expr_2)
	begin
		AXI4MemoryModule_L64F37T85_Expr <= AXI4MemoryModule_L64F37T85_Expr_1 AND AXI4MemoryModule_L64F37T85_Expr_2;
	end process;
	...
	begin
		...
		internalSameTxWrite <= AXI4MemoryModule_L64F37T85_Expr;
		...
		AXI4MemoryModule_L91F37L100T14_Object(0) <= AXI4MemoryModule_L95F29T33_Expr;
		AXI4MemoryModule_L91F37L100T14_Object(1) <= AXI4MemoryModule_L97F29T33_Expr;
		AXI4MemoryModule_L91F37L100T14_Object(2) <= AXI4MemoryModule_L99F28T32_Expr;
		AXI4MemoryModule_L91F37L100T14_Object(34 downto 27) <= State_rdata(3);
		AXI4MemoryModule_L91F37L100T14_Object(26 downto 19) <= State_rdata(2);
		AXI4MemoryModule_L91F37L100T14_Object(18 downto 11) <= State_rdata(1);
		AXI4MemoryModule_L91F37L100T14_Object(10 downto 3) <= State_rdata(0);
		AXI4MemoryModule_L91F37L100T14_Object(35) <= AXI4MemoryModule_L96F28T32_Expr;
		AXI4MemoryModule_L91F37L100T14_Object(36) <= AXI4MemoryModule_L98F28T32_Expr;
		AXI4MemoryModule_L91F37L100T14_Object(44 downto 37) <= Inputs_M2S_R_AR_ARID;
		AXI4MemoryModule_L91F37L100T14_Object(76 downto 45) <= Inputs_M2S_R_AR_ARADDR;
		AXI4MemoryModule_L91F37L100T14_Object(84 downto 77) <= Inputs_M2S_R_AR_ARLEN;
		AXI4MemoryModule_L91F37L100T14_Object(87 downto 85) <= Inputs_M2S_R_AR_ARSIZE;
		AXI4MemoryModule_L91F37L100T14_Object(89 downto 88) <= Inputs_M2S_R_AR_ARBURST;
		AXI4MemoryModule_L91F37L100T14_Object(91 downto 90) <= Inputs_M2S_R_AR_ARLOCK;
		AXI4MemoryModule_L91F37L100T14_Object(95 downto 92) <= Inputs_M2S_R_AR_ARCACHE;
		AXI4MemoryModule_L91F37L100T14_Object(98 downto 96) <= Inputs_M2S_R_AR_ARPROT;
		AXI4MemoryModule_L91F37L100T14_Object(102 downto 99) <= Inputs_M2S_R_AR_ARQOS;
		AXI4MemoryModule_L91F37L100T14_Object(110 downto 103) <= Inputs_M2S_R_AR_ARREGION;
		AXI4MemoryModule_L91F37L100T14_Object(118 downto 111) <= Inputs_M2S_R_AR_ARUSER;
		AXI4MemoryModule_L91F37L100T14_Object(119) <= Inputs_M2S_R_AR_ARVALID;
		AXI4MemoryModule_L91F37L100T14_Object(120) <= Inputs_M2S_R_R_RREADY;
		AXI4MemoryModule_L91F37L100T14_Object(128 downto 121) <= Inputs_M2S_W_AW_AWID;
		AXI4MemoryModule_L91F37L100T14_Object(160 downto 129) <= Inputs_M2S_W_AW_AWADDR;
		AXI4MemoryModule_L91F37L100T14_Object(168 downto 161) <= Inputs_M2S_W_AW_AWLEN;
		AXI4MemoryModule_L91F37L100T14_Object(171 downto 169) <= Inputs_M2S_W_AW_AWSIZE;
		AXI4MemoryModule_L91F37L100T14_Object(173 downto 172) <= Inputs_M2S_W_AW_AWBURST;
		AXI4MemoryModule_L91F37L100T14_Object(175 downto 174) <= Inputs_M2S_W_AW_AWLOCK;
		AXI4MemoryModule_L91F37L100T14_Object(179 downto 176) <= Inputs_M2S_W_AW_AWCACHE;
		AXI4MemoryModule_L91F37L100T14_Object(182 downto 180) <= Inputs_M2S_W_AW_AWPROT;
		AXI4MemoryModule_L91F37L100T14_Object(186 downto 183) <= Inputs_M2S_W_AW_AWQOS;
		AXI4MemoryModule_L91F37L100T14_Object(194 downto 187) <= Inputs_M2S_W_AW_AWREGION;
		AXI4MemoryModule_L91F37L100T14_Object(202 downto 195) <= Inputs_M2S_W_AW_AWUSER;
		AXI4MemoryModule_L91F37L100T14_Object(203) <= Inputs_M2S_W_AW_AWVALID;
		AXI4MemoryModule_L91F37L100T14_Object(211 downto 204) <= Inputs_M2S_W_W_WID;
		AXI4MemoryModule_L91F37L100T14_Object(243 downto 236) <= Inputs_M2S_W_W_WDATA(3);
		AXI4MemoryModule_L91F37L100T14_Object(235 downto 228) <= Inputs_M2S_W_W_WDATA(2);
		AXI4MemoryModule_L91F37L100T14_Object(227 downto 220) <= Inputs_M2S_W_W_WDATA(1);
		AXI4MemoryModule_L91F37L100T14_Object(219 downto 212) <= Inputs_M2S_W_W_WDATA(0);
		AXI4MemoryModule_L91F37L100T14_Object(247 downto 244) <= Inputs_M2S_W_W_WSTRB;
		AXI4MemoryModule_L91F37L100T14_Object(248) <= Inputs_M2S_W_W_WLAST;
		AXI4MemoryModule_L91F37L100T14_Object(256 downto 249) <= Inputs_M2S_W_W_WUSER;
		AXI4MemoryModule_L91F37L100T14_Object(257) <= Inputs_M2S_W_W_WVALID;
		AXI4MemoryModule_L91F37L100T14_Object(258) <= Inputs_M2S_W_B_BREADY;
		axiSlave_M2S <= AXI4MemoryModule_L91F37L100T14_Object(258 downto 37);
		axiSlave_inWREADY <= AXI4MemoryModule_L91F37L100T14_Object(36);
		axiSlave_inRVALID <= AXI4MemoryModule_L91F37L100T14_Object(35);
		axiSlave_inRDATA(3) <= AXI4MemoryModule_L91F37L100T14_Object(34 downto 27);
		axiSlave_inRDATA(2) <= AXI4MemoryModule_L91F37L100T14_Object(26 downto 19);
		axiSlave_inRDATA(1) <= AXI4MemoryModule_L91F37L100T14_Object(18 downto 11);
		axiSlave_inRDATA(0) <= AXI4MemoryModule_L91F37L100T14_Object(10 downto 3);
		axiSlave_inBVALID <= AXI4MemoryModule_L91F37L100T14_Object(2);
		axiSlave_inAWREADY <= AXI4MemoryModule_L91F37L100T14_Object(1);
		axiSlave_inARREADY <= AXI4MemoryModule_L91F37L100T14_Object(0);
