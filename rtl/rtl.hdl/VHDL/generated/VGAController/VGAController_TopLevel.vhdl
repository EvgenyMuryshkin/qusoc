...
-- 
-- System configuration name is VGAController_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
...
entity VGAController_TopLevel is
    port
    (
-- [BEGIN USER PORTS]
-- [END USER PORTS]
...
OutVPixel : out  unsigned(9 downto 0);
OutHPixel : out  unsigned(10 downto 0);
OutPixelAddress : out  unsigned(18 downto 0)
    );
end entity;

-- FSM summary
-- Packages
architecture rtl of VGAController_TopLevel is
-- [BEGIN USER SIGNALS]
-- [END USER SIGNALS]
...
VGAController_TopLevel_VGAController_hSync : entity work.VGAController_TopLevel_VGAController_hSync port map
(
...
VGAController_TopLevel_VGAController_vSync : entity work.VGAController_TopLevel_VGAController_vSync port map
(
