...
-- 
-- System configuration name is VGAController_TopLevel_VGAController_hSync, clock frequency is 1Hz, Embedded
library ieee;
...
entity VGAController_TopLevel_VGAController_hSync is
    port
    (
-- [BEGIN USER PORTS]
-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of VGAController_TopLevel_VGAController_hSync is
-- [BEGIN USER SIGNALS]
-- [END USER SIGNALS]
