...
architecture rtl of FIRStageModule16_TopLevel is
	...
	signal dspiAccumSelectordsp_iAccumSelectorHardLink : std_logic := '0';
...
iInput => dspiInputdsp_iInputHardLink,
iCoeff => dspiCoeffdsp_iCoeffHardLink,
iAccum => dspiAccumdsp_iAccumHardLink,
iAccumSelector => dspiAccumSelectordsp_iAccumSelectorHardLink,
oAccum => dspoAccumdsp_oAccumHardLink
	...
	process (dsp_iAccum, dsp_iAccumSelector, dsp_iCoeff, dsp_iInput, dsp_iIQ, dsp_oAccum, dspoAccumdsp_oAccumHardLink, FIRStageModule_L104F35L106T27_Lookup, FIRStageModule_L104F35T50_Expr, iAccum, iCoeffData, iCoeffReadAddr, iCoeffWE, iCoeffWriteAddr, iData, iDataReadAddr, iDataWE, iDataWriteAddr, iDO, iInput, iInternalFeedbackSelector, iIQ, Inputs_iAccum, Inputs_iData, Inputs_iDO, Inputs_iInput, Inputs_iInternalFeedbackSelector, Inputs_iIQ, internalIQ, State_coeff, State_data, State_IQ2)
	begin
		...
		dsp_iIQ <= internalIQ;
		dsp_iInput <= Inputs_iInput;
		dsp_iCoeff <= State_coeff;
		dsp_iAccum <= Inputs_iAccum;
		dsp_iAccumSelector <= Inputs_iInternalFeedbackSelector;
		oIQ <= State_IQ2;
		oData <= State_data;
		oAccum <= dsp_oAccum;
		dspiIQdsp_iIQHardLink <= dsp_iIQ;
		dspiInputdsp_iInputHardLink <= dsp_iInput;
		dspiCoeffdsp_iCoeffHardLink <= dsp_iCoeff;
		dspiAccumdsp_iAccumHardLink <= dsp_iAccum;
		dspiAccumSelectordsp_iAccumSelectorHardLink <= dsp_iAccumSelector;
