...
--
-- System configuration name is FIRStageModule16_TopLevel_dsp, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity FIRStageModule16_TopLevel_dsp is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		...
		iInput : in unsigned (15 downto 0);
		iCoeff : in unsigned (15 downto 0);
		iAccum : in unsigned (32 downto 0);
		iAccumSelector : in std_logic;
		oAccum : out unsigned (32 downto 0)
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of FIRStageModule16_TopLevel_dsp is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal Inputs_iInput : unsigned(15 downto 0) := (others => '0');
	signal Inputs_iCoeff : unsigned(15 downto 0) := (others => '0');
	signal Inputs_iAccum : unsigned(32 downto 0) := (others => '0');
	signal Inputs_iAccumSelector : std_logic := '0';
	signal NextState_input1 : unsigned(15 downto 0) := (others => '0');
	signal NextState_input2 : unsigned(15 downto 0) := (others => '0');
	...
	signal FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F29T85_Index : unsigned(16 downto 0) := (others => '0');
	...
	signal State_input1 : unsigned(15 downto 0) := "0000000000000000";
	constant State_input1Default : unsigned(15 downto 0) := "0000000000000000";
	signal State_input2 : unsigned(15 downto 0) := "0000000000000000";
	constant State_input2Default : unsigned(15 downto 0) := "0000000000000000";
	...
	signal FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr : unsigned(34 downto 0) := "00000000000000000000000000000000000";
	signal FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_1 : signed(34 downto 0) := "00000000000000000000000000000000000";
	signal FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_2 : signed(34 downto 0) := "00000000000000000000000000000000000";
	...
	signal FIRStageDSPModule_L59F13L61T32_Lookup : unsigned(32 downto 0) := "000000000000000000000000000000000";
	signal FIRStageDSPModule_L59F13L61T32_LookupMultiplexerAddress : std_logic := '0';
	signal FIRStageDSPModule_L59F13L61T32_Lookup1 : unsigned(32 downto 0) := "000000000000000000000000000000000";
	signal FIRStageDSPModule_L59F13L61T32_Lookup2 : unsigned(32 downto 0) := "000000000000000000000000000000000";
begin
	process (BoardSignals, NextState_accum, NextState_coeff, NextState_input1, NextState_input2, NextState_mult, NextState_sum)
	begin
	...
	process (FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_1, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_2)
	begin
		FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr <= resize(unsigned(signed(resize(FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_1, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_1'length + 1)) + signed(resize(FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_2, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_2'length + 1))), FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr'length);
	end process;
	...
	process (FIRStageDSPModule_L59F13L61T32_Lookup1, FIRStageDSPModule_L59F13L61T32_Lookup2, FIRStageDSPModule_L59F13L61T32_LookupMultiplexerAddress)
	begin
		case FIRStageDSPModule_L59F13L61T32_LookupMultiplexerAddress is
			when '0' =>
			...
			when others =>
				FIRStageDSPModule_L59F13L61T32_Lookup <= "000000000000000000000000000000000";
		end case;
	end process;
	process (FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F29T85_Index, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L73F30T82_Index, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L75F31T96_Index, Inputs_iCoeff, Inputs_iInput, State_accum, State_coeff, State_input1, State_input2, State_mult, State_sum)
	begin
	...
	process (FIRStageDSPModule_L59F13L61T32_Lookup, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L73F31T54_Expr, FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L75F32T67_Expr, iAccum, iAccumSelector, iCoeff, iInput, iIQ, Inputs_iAccum, Inputs_iAccumSelector, internalAccumInputData, State_accum, State_coeff, State_input2, State_mult, State_sum)
	begin
		FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_1(34 downto 16) <= (others => '0');
		FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_1(15 downto 0) <= signed(State_input2);
		FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_2(34 downto 33) <= (others => '0');
		FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr_2(32 downto 0) <= signed(Inputs_iAccum);
		...
		Inputs_iIQ <= iIQ;
		Inputs_iInput <= iInput;
		Inputs_iCoeff <= iCoeff;
		Inputs_iAccum <= iAccum;
		Inputs_iAccumSelector <= iAccumSelector;
		internalAccumInputData <= FIRStageDSPModule_L59F13L61T32_Lookup;
		FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F29T85_Index <= FIRStageDSPModule_L66F9L76T10_FIRStageDSPModule_L72F30T58_Expr(16 downto 0);
		...
		oAccum <= State_accum;
		FIRStageDSPModule_L59F13L61T32_Lookup1 <= Inputs_iAccum;
		FIRStageDSPModule_L59F13L61T32_Lookup2 <= State_accum;
		FIRStageDSPModule_L59F13L61T32_LookupMultiplexerAddress <= Inputs_iAccumSelector;
	end process;
