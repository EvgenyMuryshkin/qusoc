...
--
-- System configuration name is StructByMemberDirectModule_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity StructByMemberDirectModule_TopLevel is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of StructByMemberDirectModule_TopLevel is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
