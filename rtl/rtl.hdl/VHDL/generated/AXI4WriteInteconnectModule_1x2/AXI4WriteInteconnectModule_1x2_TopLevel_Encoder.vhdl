...
--
-- System configuration name is AXI4WriteInteconnectModule_1x2_TopLevel_Encoder, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4WriteInteconnectModule_1x2_TopLevel_Encoder is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
		...
		MSBValue : out unsigned (0 downto 0)
	);
end entity;
-- FSM summary
-- Packages
architecture rtl of AXI4WriteInteconnectModule_1x2_TopLevel_Encoder is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal AXI4EncoderModule_L59F40T121_Resize : unsigned(0 downto 0) := (others => '0');
	signal AXI4EncoderModule_L59F40T101_Expr : unsigned(0 downto 0) := "0";
	signal AXI4EncoderModule_L59F40T101_Expr_1 : unsigned(0 downto 0) := "0";
