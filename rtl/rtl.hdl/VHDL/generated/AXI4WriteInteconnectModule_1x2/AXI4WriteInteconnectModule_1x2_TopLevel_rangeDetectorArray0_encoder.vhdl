...
--
-- System configuration name is AXI4WriteInteconnectModule_1x2_TopLevel_rangeDetectorArray0_encoder, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4WriteInteconnectModule_1x2_TopLevel_rangeDetectorArray0_encoder is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4WriteInteconnectModule_1x2_TopLevel_rangeDetectorArray0_encoder is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
