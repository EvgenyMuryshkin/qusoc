...
-- 
-- System configuration name is VGAAlienArtModule_TopLevel_VGAAlienArtModule_vgaController_VGAController_hSync, clock frequency is 1Hz, Embedded
library ieee;
...
entity VGAAlienArtModule_TopLevel_VGAAlienArtModule_vgaController_VGAController_hSync is
    port
    (
-- [BEGIN USER PORTS]
-- [END USER PORTS]
...
OutCounter : out  unsigned(11 downto 1)
    );
end entity;

-- FSM summary
-- Packages
architecture rtl of VGAAlienArtModule_TopLevel_VGAAlienArtModule_vgaController_VGAController_hSync is
-- [BEGIN USER SIGNALS]
-- [END USER SIGNALS]
...
constant visible : unsigned(9 downto 0)  := "1100100000";
constant fp : unsigned(9 downto 0)  := "1101001000";
constant sp : unsigned(9 downto 0)  := "1111001000";
constant bp : unsigned(10 downto 0)  := "10000100000";
constant max : unsigned(10 downto 0)  := "10000011111";
constant capacity : unsigned(3 downto 0)  := "1011";
...
signal NextState_counter : unsigned(10 downto 0) := (others => '0');
signal internalIsMax : std_logic := '0';
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F37T108_Source : unsigned(10 downto 0) := (others => '0');
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F69T87_Source : std_logic := '0';
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F37T126_Resize : unsigned(10 downto 0) := (others => '0');
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F37T137_SignChange : unsigned(10 downto 0) := (others => '0');
signal State_counter : unsigned(10 downto 0)  := "00000000000";
constant State_counterDefault : unsigned(10 downto 0)  := "00000000000";
...
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F90T107_Expr : unsigned(12 downto 0)  := "0000000000000";
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F90T107_Expr_1 : signed(12 downto 0)  := "0000000000000";
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F90T107_Expr_2 : signed(12 downto 0)  := "0000000000000";
signal VGASyncModule_L54F31T51_Expr : std_logic := '0';
signal VGASyncModule_L54F31T51_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L54F31T51_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L56F35T58_Expr : std_logic := '0';
signal VGASyncModule_L56F35T58_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L56F35T58_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L57F30T54_Expr : std_logic := '0';
signal VGASyncModule_L57F30T54_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L57F30T54_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L57F58T76_Expr : std_logic := '0';
signal VGASyncModule_L57F58T76_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L57F58T76_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L58F30T49_Expr : std_logic := '0';
signal VGASyncModule_L58F30T49_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L58F30T49_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L58F53T71_Expr : std_logic := '0';
signal VGASyncModule_L58F53T71_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L58F53T71_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L59F30T49_Expr : std_logic := '0';
signal VGASyncModule_L59F30T49_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L59F30T49_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L59F53T71_Expr : std_logic := '0';
signal VGASyncModule_L59F53T71_ExprLhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L59F53T71_ExprRhs : signed(11 downto 0)  := "000000000000";
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup : unsigned(10 downto 0)  := "00000000000";
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_LookupMultiplexerAddress : std_logic := '0';
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup1 : unsigned(10 downto 0)  := "00000000000";
signal VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup2 : unsigned(10 downto 0)  := "00000000000";
begin
...
VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup <= VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup2;
  when others => 
VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup <= "00000000000";
end case;
...
VGASyncModule_L64F9L67T10_VGASyncModule_L66F53T107_Lookup1 <= VGASyncModule_L64F9L67T10_VGASyncModule_L66F90T107_Expr(10 downto 0);
