...
-- 
-- System configuration name is VGAAlienArtModule_TopLevel_VGAAlienArtModule_patternTimer, clock frequency is 1Hz, Embedded
library ieee;
...
entity VGAAlienArtModule_TopLevel_VGAAlienArtModule_patternTimer is
    port
    (
-- [BEGIN USER PORTS]
-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of VGAAlienArtModule_TopLevel_VGAAlienArtModule_patternTimer is
-- [BEGIN USER SIGNALS]
-- [END USER SIGNALS]
...
constant countTo : unsigned(27 downto 0)  := "1011111010111100000111111111";
constant CapacityBits : unsigned(4 downto 0)  := "11100";
...
signal NextState_counter : unsigned(27 downto 0) := (others => '0');
signal active : std_logic := '0';
signal TimerModule_L51F9L53T10_TimerModule_L52F63T81_Source : std_logic := '0';
signal TimerModule_L51F9L53T10_TimerModule_L52F33T124_Resize : unsigned(27 downto 0) := (others => '0');
signal TimerModule_L51F9L53T10_TimerModule_L52F33T135_SignChange : unsigned(27 downto 0) := (others => '0');
signal State_counter : unsigned(27 downto 0)  := "0000000000000000000000000000";
constant State_counterDefault : unsigned(27 downto 0)  := "0000000000000000000000000000";
...
signal TimerModule_L51F9L53T10_TimerModule_L52F84T101_Expr : unsigned(29 downto 0)  := "000000000000000000000000000000";
signal TimerModule_L51F9L53T10_TimerModule_L52F84T101_Expr_1 : signed(29 downto 0)  := "000000000000000000000000000000";
signal TimerModule_L51F9L53T10_TimerModule_L52F84T101_Expr_2 : signed(29 downto 0)  := "000000000000000000000000000000";
signal TimerModule_L47F24T48_Expr : std_logic := '0';
signal TimerModule_L47F24T48_ExprLhs : signed(28 downto 0)  := "00000000000000000000000000000";
signal TimerModule_L47F24T48_ExprRhs : signed(28 downto 0)  := "00000000000000000000000000000";
signal TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup : unsigned(27 downto 0)  := "0000000000000000000000000000";
signal TimerModule_L51F9L53T10_TimerModule_L52F34T101_LookupMultiplexerAddress : std_logic := '0';
signal TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup1 : unsigned(27 downto 0)  := "0000000000000000000000000000";
signal TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup2 : unsigned(27 downto 0)  := "0000000000000000000000000000";
begin
...
TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup <= TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup2;
  when others => 
TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup <= "0000000000000000000000000000";
end case;
...
OutActive <= active;
TimerModule_L51F9L53T10_TimerModule_L52F34T101_Lookup1 <= TimerModule_L51F9L53T10_TimerModule_L52F84T101_Expr(27 downto 0);
