...
use work.Quokka.all;
entity OverrideScheduleComposition_TopLevel_AutoOverride is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of OverrideScheduleComposition_TopLevel_AutoOverride is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	signal CombinationalAutoValueOverride_L9F49T103_WhenTrue : unsigned(7 downto 0) := "00000000";
	signal CombinationalAutoValueOverride_L9F49T103_WhenFalse : unsigned(7 downto 0) := "00000000";
	signal CombinationalAutoValueOverride_L9F49T103_Ternary : unsigned(7 downto 0) := "00000000";
...
begin
	...
	begin
		...
		CombinationalAutoValueOverride_L9F49T103_WhenTrue <= CombinationalAutoValueOverride_L9F69T87_Expr(7 downto 0);
		CombinationalAutoValueOverride_L9F49T103_WhenFalse <= CombinationalOverridesBase_L14F41T96_Ternary;
		CombinationalAutoValueOverride_L9F42T104_Cast <= CombinationalAutoValueOverride_L9F49T103_Ternary;
