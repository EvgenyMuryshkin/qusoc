...
--
-- System configuration name is AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_master, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_master is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_master is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
