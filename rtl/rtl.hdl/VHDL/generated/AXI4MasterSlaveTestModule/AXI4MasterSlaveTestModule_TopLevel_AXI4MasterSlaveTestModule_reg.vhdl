...
use work.Quokka.all;
entity AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_reg is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_reg is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
...
begin
	...
	AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_reg_AXI4RegisterModule_axiSlave : entity work.AXI4MasterSlaveTestModule_TopLevel_AXI4MasterSlaveTestModule_reg_AXI4RegisterModule_axiSlave
	port map
	(
