...
architecture rtl of AXI4MasterSlaveTestModule_TopLevel is
	...
	constant AXI4MasterSlaveTestModule_L64F30T31_Expr : std_logic := '0';
	...
	signal AXI4MasterSlaveTestModule_L57F35L69T14_Object : unsigned(175 downto 0) := (others => '0');
...
begin
	...
	begin
		...
		Inputs_SWE <= SWE;
		Inputs_WSTRB <= WSTRB;
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(7 downto 0) <= master_M2S(7 downto 0);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(39 downto 8) <= master_M2S(39 downto 8);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(47 downto 40) <= master_M2S(47 downto 40);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(50 downto 48) <= master_M2S(50 downto 48);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(52 downto 51) <= master_M2S(52 downto 51);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(54 downto 53) <= master_M2S(54 downto 53);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(58 downto 55) <= master_M2S(58 downto 55);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(61 downto 59) <= master_M2S(61 downto 59);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(65 downto 62) <= master_M2S(65 downto 62);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(73 downto 66) <= master_M2S(73 downto 66);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(81 downto 74) <= master_M2S(81 downto 74);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(82) <= master_M2S(82);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(83) <= master_M2S(83);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(91 downto 84) <= master_M2S(91 downto 84);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(123 downto 92) <= master_M2S(123 downto 92);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(131 downto 124) <= master_M2S(131 downto 124);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(134 downto 132) <= master_M2S(134 downto 132);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(136 downto 135) <= master_M2S(136 downto 135);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(138 downto 137) <= master_M2S(138 downto 137);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(142 downto 139) <= master_M2S(142 downto 139);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(145 downto 143) <= master_M2S(145 downto 143);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(149 downto 146) <= master_M2S(149 downto 146);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(157 downto 150) <= master_M2S(157 downto 150);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(165 downto 158) <= master_M2S(165 downto 158);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(166) <= master_M2S(166);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(174 downto 167) <= master_M2S(174 downto 167);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(206 downto 175) <= master_M2S(206 downto 175);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(210 downto 207) <= master_M2S(210 downto 207);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(211) <= master_M2S(211);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(219 downto 212) <= master_M2S(219 downto 212);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(220) <= master_M2S(220);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(221) <= master_M2S(221);
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(253 downto 222) <= Inputs_InData;
		AXI4MasterSlaveTestModule_L47F32L55T14_Object(254) <= Inputs_SWE;
		reg_Reg <= AXI4MasterSlaveTestModule_L47F32L55T14_Object(254 downto 222);
		reg_M2S <= AXI4MasterSlaveTestModule_L47F32L55T14_Object(221 downto 0);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(31 downto 1) <= (
			others => '0'
		)
		;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(0) <= AXI4MasterSlaveTestModule_L64F30T31_Expr;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(63 downto 33) <= (
			others => '0'
		)
		;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(32) <= AXI4MasterSlaveTestModule_L65F30T31_Expr;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(64) <= Inputs_MRE;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(96 downto 65) <= Inputs_InData;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(97) <= Inputs_MWE;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(101 downto 98) <= Inputs_WSTRB;
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(102) <= reg_S2M(0);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(110 downto 103) <= reg_S2M(8 downto 1);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(142 downto 111) <= reg_S2M(40 downto 9);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(144 downto 143) <= reg_S2M(42 downto 41);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(145) <= reg_S2M(43);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(153 downto 146) <= reg_S2M(51 downto 44);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(154) <= reg_S2M(52);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(155) <= reg_S2M(53);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(163 downto 156) <= reg_S2M(61 downto 54);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(165 downto 164) <= reg_S2M(63 downto 62);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(173 downto 166) <= reg_S2M(71 downto 64);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(174) <= reg_S2M(72);
		AXI4MasterSlaveTestModule_L57F35L69T14_Object(175) <= reg_S2M(73);
		master_S2M <= AXI4MasterSlaveTestModule_L57F35L69T14_Object(175 downto 102);
		master_Master <= AXI4MasterSlaveTestModule_L57F35L69T14_Object(101 downto 0);
		BVALID <= reg_S2M(72);
		RACK <= master_RACK;
