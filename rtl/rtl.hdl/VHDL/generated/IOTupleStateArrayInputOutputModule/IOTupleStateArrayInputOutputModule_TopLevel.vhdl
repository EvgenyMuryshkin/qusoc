...
use work.Quokka.all;
entity IOTupleStateArrayInputOutputModule_TopLevel is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of IOTupleStateArrayInputOutputModule_TopLevel is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
	...
	type State_ValueArray is array (0 to 1) of unsigned (167 downto 0);
	...
	type NextState_ValueArray is array (0 to 1) of unsigned (167 downto 0);
...
begin
	...
	begin
		if rising_edge(Clock) then
			if Reset = '1' then
				...
				for State_Value_Iterator in 0 to 1 loop
	...
	begin
		for NextState_Value_Iterator in 0 to 1 loop
	...
	begin
		...
		Output_iTupleArray1_Item1 <= State_Value(1)(167);
		Output_iTupleArray1_Item2 <= State_Value(1)(166 downto 163);
		Output_iTupleArray1_Item3_L2Tuple_Item1 <= State_Value(1)(162 downto 155);
		Output_iTupleArray1_Item3_L2Tuple_Item2_L2Values1 <= State_Value(1)(154);
		Output_iTupleArray1_Item3_L2Tuple_Item2_L2Values0 <= State_Value(1)(153);
		Output_iTupleArray1_Item3_L2Tuple_Item2_L2Flag <= State_Value(1)(152);
		Output_iTupleArray1_Item3_L2Tuple_Item31_L2Values1 <= State_Value(1)(151 downto 149);
		Output_iTupleArray1_Item3_L2Tuple_Item31_L2Values0 <= State_Value(1)(148 downto 146);
		Output_iTupleArray1_Item3_L2Tuple_Item31_L2Flag <= State_Value(1)(145);
		Output_iTupleArray1_Item3_L2Tuple_Item30_L2Values1 <= State_Value(1)(144 downto 142);
		Output_iTupleArray1_Item3_L2Tuple_Item30_L2Values0 <= State_Value(1)(141 downto 139);
		Output_iTupleArray1_Item3_L2Tuple_Item30_L2Flag <= State_Value(1)(138);
		Output_iTupleArray1_Item3_L2Array1_L2Values1 <= State_Value(1)(137 downto 135);
		Output_iTupleArray1_Item3_L2Array1_L2Values0 <= State_Value(1)(134 downto 132);
		Output_iTupleArray1_Item3_L2Array1_L2Flag <= State_Value(1)(131);
		Output_iTupleArray1_Item3_L2Array0_L2Values1 <= State_Value(1)(130 downto 128);
		Output_iTupleArray1_Item3_L2Array0_L2Values0 <= State_Value(1)(127 downto 125);
		Output_iTupleArray1_Item3_L2Array0_L2Flag <= State_Value(1)(124);
		Output_iTupleArray1_Item3_L2_L2Values1 <= State_Value(1)(123);
		Output_iTupleArray1_Item3_L2_L2Values0 <= State_Value(1)(122);
		Output_iTupleArray1_Item3_L2_L2Flag <= State_Value(1)(121);
		Output_iTupleArray1_Item3_L1Flag <= State_Value(1)(120);
		Output_iTupleArray1_Item41_L2Values1 <= State_Value(1)(119);
		Output_iTupleArray1_Item41_L2Values0 <= State_Value(1)(118);
		Output_iTupleArray1_Item41_L2Flag <= State_Value(1)(117);
		Output_iTupleArray1_Item40_L2Values1 <= State_Value(1)(116);
		Output_iTupleArray1_Item40_L2Values0 <= State_Value(1)(115);
		Output_iTupleArray1_Item40_L2Flag <= State_Value(1)(114);
		Output_iTupleArray0_Item1 <= State_Value(1)(113);
		Output_iTupleArray0_Item2 <= State_Value(1)(112 downto 109);
		Output_iTupleArray0_Item3_L2Tuple_Item1 <= State_Value(1)(108 downto 101);
		Output_iTupleArray0_Item3_L2Tuple_Item2_L2Values1 <= State_Value(1)(100);
		Output_iTupleArray0_Item3_L2Tuple_Item2_L2Values0 <= State_Value(1)(99);
		Output_iTupleArray0_Item3_L2Tuple_Item2_L2Flag <= State_Value(1)(98);
		Output_iTupleArray0_Item3_L2Tuple_Item31_L2Values1 <= State_Value(1)(97 downto 95);
		Output_iTupleArray0_Item3_L2Tuple_Item31_L2Values0 <= State_Value(1)(94 downto 92);
		Output_iTupleArray0_Item3_L2Tuple_Item31_L2Flag <= State_Value(1)(91);
		Output_iTupleArray0_Item3_L2Tuple_Item30_L2Values1 <= State_Value(1)(90 downto 88);
		Output_iTupleArray0_Item3_L2Tuple_Item30_L2Values0 <= State_Value(1)(87 downto 85);
		Output_iTupleArray0_Item3_L2Tuple_Item30_L2Flag <= State_Value(1)(84);
		Output_iTupleArray0_Item3_L2Array1_L2Values1 <= State_Value(1)(83 downto 81);
		Output_iTupleArray0_Item3_L2Array1_L2Values0 <= State_Value(1)(80 downto 78);
		Output_iTupleArray0_Item3_L2Array1_L2Flag <= State_Value(1)(77);
		Output_iTupleArray0_Item3_L2Array0_L2Values1 <= State_Value(1)(76 downto 74);
		Output_iTupleArray0_Item3_L2Array0_L2Values0 <= State_Value(1)(73 downto 71);
		Output_iTupleArray0_Item3_L2Array0_L2Flag <= State_Value(1)(70);
		Output_iTupleArray0_Item3_L2_L2Values1 <= State_Value(1)(69);
		Output_iTupleArray0_Item3_L2_L2Values0 <= State_Value(1)(68);
		Output_iTupleArray0_Item3_L2_L2Flag <= State_Value(1)(67);
		Output_iTupleArray0_Item3_L1Flag <= State_Value(1)(66);
		Output_iTupleArray0_Item41_L2Values1 <= State_Value(1)(65);
		Output_iTupleArray0_Item41_L2Values0 <= State_Value(1)(64);
		Output_iTupleArray0_Item41_L2Flag <= State_Value(1)(63);
		Output_iTupleArray0_Item40_L2Values1 <= State_Value(1)(62);
		Output_iTupleArray0_Item40_L2Values0 <= State_Value(1)(61);
		Output_iTupleArray0_Item40_L2Flag <= State_Value(1)(60);
		Output_iTuple_Item1 <= State_Value(1)(59);
		Output_iTuple_Item2 <= State_Value(1)(58 downto 51);
		Output_iTuple_Item31 <= State_Value(1)(50 downto 47);
		Output_iTuple_Item30 <= State_Value(1)(46 downto 43);
		Output_iTuple_Item4_L2Tuple_Item1 <= State_Value(1)(42 downto 35);
		Output_iTuple_Item4_L2Tuple_Item2_L2Values1 <= State_Value(1)(34);
		Output_iTuple_Item4_L2Tuple_Item2_L2Values0 <= State_Value(1)(33);
		Output_iTuple_Item4_L2Tuple_Item2_L2Flag <= State_Value(1)(32);
		Output_iTuple_Item4_L2Tuple_Item31_L2Values1 <= State_Value(1)(31 downto 29);
		Output_iTuple_Item4_L2Tuple_Item31_L2Values0 <= State_Value(1)(28 downto 26);
		Output_iTuple_Item4_L2Tuple_Item31_L2Flag <= State_Value(1)(25);
		Output_iTuple_Item4_L2Tuple_Item30_L2Values1 <= State_Value(1)(24 downto 22);
		Output_iTuple_Item4_L2Tuple_Item30_L2Values0 <= State_Value(1)(21 downto 19);
		Output_iTuple_Item4_L2Tuple_Item30_L2Flag <= State_Value(1)(18);
		Output_iTuple_Item4_L2Array1_L2Values1 <= State_Value(1)(17 downto 15);
		Output_iTuple_Item4_L2Array1_L2Values0 <= State_Value(1)(14 downto 12);
		Output_iTuple_Item4_L2Array1_L2Flag <= State_Value(1)(11);
		Output_iTuple_Item4_L2Array0_L2Values1 <= State_Value(1)(10 downto 8);
		Output_iTuple_Item4_L2Array0_L2Values0 <= State_Value(1)(7 downto 5);
		Output_iTuple_Item4_L2Array0_L2Flag <= State_Value(1)(4);
		Output_iTuple_Item4_L2_L2Values1 <= State_Value(1)(3);
		Output_iTuple_Item4_L2_L2Values0 <= State_Value(1)(2);
		Output_iTuple_Item4_L2_L2Flag <= State_Value(1)(1);
		Output_iTuple_Item4_L1Flag <= State_Value(1)(0);
	end process;
