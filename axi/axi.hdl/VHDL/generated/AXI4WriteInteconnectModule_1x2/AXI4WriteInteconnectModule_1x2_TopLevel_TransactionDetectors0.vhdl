...
use work.Quokka.all;
entity AXI4WriteInteconnectModule_1x2_TopLevel_TransactionDetectors0 is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4WriteInteconnectModule_1x2_TopLevel_TransactionDetectors0 is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
