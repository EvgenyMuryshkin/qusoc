...
begin
	...
	begin
		...
		RangeDetectorModule_L33F33T58_ExprRhs(32 downto 29) <= (
			others => '0'
		)
		;
		RangeDetectorModule_L33F33T58_ExprRhs(28 downto 0) <= signed(rangeFrom);
		RangeDetectorModule_L33F62T85_ExprLhs(32) <= '0';
		RangeDetectorModule_L33F62T85_ExprLhs(31 downto 0) <= signed(Inputs_Value);
		RangeDetectorModule_L33F62T85_ExprRhs(32 downto 29) <= (
			others => '0'
		)
		;
		RangeDetectorModule_L33F62T85_ExprRhs(28 downto 0) <= signed(rangeTo);
