...
--
-- System configuration name is AXI4InteconnectModule_2x2_TopLevel_readInterconnect_Encoder, clock frequency is 1Hz, Embedded
library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;
use work.Quokka.all;
entity AXI4InteconnectModule_2x2_TopLevel_readInterconnect_Encoder is
	port
	(
		-- [BEGIN USER PORTS]
		-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of AXI4InteconnectModule_2x2_TopLevel_readInterconnect_Encoder is
	-- [BEGIN USER SIGNALS]
	-- [END USER SIGNALS]
