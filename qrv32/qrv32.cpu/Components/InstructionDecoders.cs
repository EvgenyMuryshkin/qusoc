...
namespace QRV32.CPU
{
    ...
    public class InstructionDecoderModule : RTLCombinationalModule<InstructionDecoderInputs>
    {
        ...
        public RTLBitArray STypeImm => new RTLBitArray(RTLBitArrayInitType.MSB, internalBits[31, 25], internalBits[11, 7]).Signed().Resized(32);
        public RTLBitArray BTypeImm => new RTLBitArray(RTLBitArrayInitType.MSB, internalBits[31], internalBits[7], internalBits[30, 25], internalBits[11, 8], false).Signed().Resized(32);
        public RTLBitArray UTypeImm => new RTLBitArray(RTLBitArrayInitType.MSB, internalBits[31, 12], ZeroU32[11, 0]).Signed().Resized(32);
        public RTLBitArray JTypeImm => new RTLBitArray(RTLBitArrayInitType.MSB, internalBits[31], internalBits[19, 12], internalBits[20], internalBits[30, 21], false).Signed().Resized(32);
